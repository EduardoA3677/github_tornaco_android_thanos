...
# instance fields
.field public Oooo:Llyiahf/vczjk/vw2;

.field public Oooo0oO:Llyiahf/vczjk/oOo00ooO;

.field public Oooo0oo:Lgithub/tornaco/android/thanos/core/pm/AppInfo;

.field public final OoooO0:Llyiahf/vczjk/cp8;

.field public OoooO00:Llyiahf/vczjk/dl5;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lnow/fortuitous/thanos/apps/AppDetailsActivity;->OoooO0:Llyiahf/vczjk/cp8;

    return-void
.end method

.method public static OooOoOO(Landroidx/fragment/app/FragmentActivity;)Llyiahf/vczjk/jt;
    .locals 3
    ...
    const-class p0, Llyiahf/vczjk/jt;
    ...
    check-cast p0, Llyiahf/vczjk/jt;
...
.method public static OooOoo(Landroid/content/Context;Lgithub/tornaco/android/thanos/core/pm/AppInfo;)V
    ...
    invoke-static {p0, v3, v0}, Llyiahf/vczjk/bua;->OoooO00(Landroid/content/Context;Ljava/lang/Class;Landroid/os/Bundle;)V
...
.method public final OooOoo0()V
    ...
    iget-object v0, p0, Lnow/fortuitous/thanos/apps/AppDetailsActivity;->Oooo:Llyiahf/vczjk/vw2;

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Landroidx/fragment/app/FragmentActivity;->OooOo00()Llyiahf/vczjk/zc3;
    ...
    iput-object v0, p0, Lnow/fortuitous/thanos/apps/AppDetailsActivity;->Oooo:Llyiahf/vczjk/vw2;

    new-instance v1, Llyiahf/vczjk/vw2;

    invoke-direct {v1}, Llyiahf/vczjk/vw2;-><init>()V

    iput-object v1, p0, Lnow/fortuitous/thanos/apps/AppDetailsActivity;->Oooo:Llyiahf/vczjk/vw2;
    ...
    iget-object v2, p0, Lnow/fortuitous/thanos/apps/AppDetailsActivity;->Oooo:Llyiahf/vczjk/vw2;
    ...
    iget-object v3, p0, Lnow/fortuitous/thanos/apps/AppDetailsActivity;->Oooo:Llyiahf/vczjk/vw2;
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    sget v3, Llyiahf/vczjk/oOo00ooO;->OooOOO:I
    ...
    check-cast v2, Llyiahf/vczjk/oOo00ooO;

    iput-object v2, p0, Lnow/fortuitous/thanos/apps/AppDetailsActivity;->Oooo0oO:Llyiahf/vczjk/oOo00ooO;
    ...
    iget-object v2, p0, Lnow/fortuitous/thanos/apps/AppDetailsActivity;->Oooo0oO:Llyiahf/vczjk/oOo00ooO;

    iget-object v2, v2, Llyiahf/vczjk/oOo00ooO;->OooOOO0:Landroidx/appcompat/widget/Toolbar;
    ...
    invoke-virtual {v2, v0}, Llyiahf/vczjk/c6a;->oo000o(Z)V
    ...
    new-instance v2, Llyiahf/vczjk/dl5;

    invoke-direct {v2, p0}, Llyiahf/vczjk/dl5;-><init>(Landroid/content/Context;)V

    iput-object v2, p0, Lnow/fortuitous/thanos/apps/AppDetailsActivity;->OoooO00:Llyiahf/vczjk/dl5;

    const-string v3, "..."

    invoke-virtual {v2, v3}, Llyiahf/vczjk/dl5;->OooO0O0(Ljava/lang/String;)V

    invoke-static {p0}, Lnow/fortuitous/thanos/apps/AppDetailsActivity;->OooOoOO(Landroidx/fragment/app/FragmentActivity;)Llyiahf/vczjk/jt;
    ...
    invoke-virtual {v2, p0}, Landroidx/databinding/ViewDataBinding;->setLifecycleOwner(Llyiahf/vczjk/uy4;)V

    iget-object v2, p0, Lnow/fortuitous/thanos/apps/AppDetailsActivity;->Oooo0oO:Llyiahf/vczjk/oOo00ooO;

    invoke-virtual {v2}, Landroidx/databinding/ViewDataBinding;->executePendingBindings()V

    new-instance v2, Llyiahf/vczjk/ss;

    invoke-direct {v2, p0, v1}, Llyiahf/vczjk/ss;-><init>(Lnow/fortuitous/thanos/apps/AppDetailsActivity;I)V

    iget-object v3, p0, Lnow/fortuitous/thanos/apps/AppDetailsActivity;->OoooO0:Llyiahf/vczjk/cp8;

    invoke-virtual {v3, v2}, Llyiahf/vczjk/cp8;->OooO0oO(Llyiahf/vczjk/ze3;)V

    new-instance v2, Llyiahf/vczjk/ss;

    invoke-direct {v2, p0, v0}, Llyiahf/vczjk/ss;-><init>(Lnow/fortuitous/thanos/apps/AppDetailsActivity;I)V

    new-instance v0, Llyiahf/vczjk/bp8;

    invoke-direct {v0, v1, v3, v2}, Llyiahf/vczjk/bp8;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    iget-object v1, v3, Llyiahf/vczjk/cp8;->OooO00o:Llyiahf/vczjk/yo8;

    iput-object v0, v1, Llyiahf/vczjk/yo8;->OooO0OO:Llyiahf/vczjk/bp8;
...
.method public final onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    new-instance v0, Llyiahf/vczjk/ts;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Llyiahf/vczjk/ts;-><init>(Lnow/fortuitous/thanos/apps/AppDetailsActivity;I)V

    invoke-static {p1, v0}, Llyiahf/vczjk/on1;->OooO0OO(Landroid/content/Context;Llyiahf/vczjk/oe3;)V
    ...
    invoke-virtual {p1, v3, v2}, Llyiahf/vczjk/kd5;->OooOOo(ILandroid/content/DialogInterface$OnClickListener;)V
    ...
    iput-boolean v4, p1, Llyiahf/vczjk/al5;->OooO0oO:Z
    ...
    iget-object v0, p0, Lnow/fortuitous/thanos/apps/AppDetailsActivity;->OoooO0:Llyiahf/vczjk/cp8;
