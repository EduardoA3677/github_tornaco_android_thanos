.class public final Llyiahf/vczjk/ok0;
...
.field public final OooOOO0:Llyiahf/vczjk/bd5;
...
.method static constructor <clinit>()V
    ...
    :goto_1
    sput-boolean v0, Llyiahf/vczjk/ok0;->OooOOo:Z

    return-void
.end method

.method public constructor <init>(Llyiahf/vczjk/bd5;I)V
    .locals 1

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    sget-object v0, Llyiahf/vczjk/n76;->OooO0OO:Landroid/graphics/Paint;

    iput-object v0, p0, Llyiahf/vczjk/ok0;->OooOOO:Landroid/graphics/Paint;

    sget-object v0, Llyiahf/vczjk/n76;->OooO0O0:Landroid/graphics/RectF;

    iput-object v0, p0, Llyiahf/vczjk/ok0;->OooOOOO:Landroid/graphics/RectF;

    sget-object v0, Llyiahf/vczjk/n76;->OooO00o:Landroid/graphics/Rect;

    iput-object v0, p0, Llyiahf/vczjk/ok0;->OooOOOo:Landroid/graphics/Rect;

    iput-object p1, p0, Llyiahf/vczjk/ok0;->OooOOO0:Llyiahf/vczjk/bd5;

    iput p2, p0, Llyiahf/vczjk/ok0;->OooOOo0:I
...
.method public final drawLeadingMargin(Landroid/graphics/Canvas;Landroid/graphics/Paint;IIIIILjava/lang/CharSequence;IIZLandroid/text/Layout;)V
    ...
    iget-object p5, p0, Llyiahf/vczjk/ok0;->OooOOOo:Landroid/graphics/Rect;

    if-eqz p11, :cond_8

    invoke-static {p8, p0, p9}, Llyiahf/vczjk/rs;->OoooOo0(Ljava/lang/CharSequence;Ljava/lang/Object;I)Z
    ...
    :cond_0
    iget-object p7, p0, Llyiahf/vczjk/ok0;->OooOOO:Landroid/graphics/Paint;

    invoke-virtual {p7, p2}, Landroid/graphics/Paint;->set(Landroid/graphics/Paint;)V

    iget-object p2, p0, Llyiahf/vczjk/ok0;->OooOOO0:Llyiahf/vczjk/bd5;

    invoke-virtual {p2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget p8, p2, Llyiahf/vczjk/bd5;->OooO00o:I
    ...
    iget p2, p2, Llyiahf/vczjk/bd5;->OooO0OO:I
    ...
    sget-boolean v0, Llyiahf/vczjk/ok0;->OooOOo:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget v1, p0, Llyiahf/vczjk/ok0;->OooOOo0:I
    ...
    :cond_6
    :goto_4
    iget-object p4, p0, Llyiahf/vczjk/ok0;->OooOOOO:Landroid/graphics/RectF;
...
.method public final getLeadingMargin(Z)I
    ...
    iget-object p1, p0, Llyiahf/vczjk/ok0;->OooOOO0:Llyiahf/vczjk/bd5;

    iget p1, p1, Llyiahf/vczjk/bd5;->OooO00o:I
