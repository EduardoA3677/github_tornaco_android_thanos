.class public final Llyiahf/vczjk/kw6;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;ILlyiahf/vczjk/uv6;)V
    .locals 2
    ...
    iput-object p1, p0, Llyiahf/vczjk/kw6;->OooO00o:Landroid/content/Context;

    iput p2, p0, Llyiahf/vczjk/kw6;->OooO0O0:I

    iput-object p3, p0, Llyiahf/vczjk/kw6;->OooO0OO:Llyiahf/vczjk/uv6;
    ...
    iput-object v0, p0, Llyiahf/vczjk/kw6;->OooO0Oo:Landroid/content/pm/PackageManager;
    ...
    iput-object v0, p0, Llyiahf/vczjk/kw6;->OooO0o0:Ljava/util/HashSet;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, Llyiahf/vczjk/kw6;->OooO0o:Ljava/util/HashSet;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, Llyiahf/vczjk/kw6;->OooO0oO:Ljava/util/HashSet;
    ...
    iput-object v0, p0, Llyiahf/vczjk/kw6;->OooO:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Llyiahf/vczjk/kw6;->OooOO0:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Llyiahf/vczjk/kw6;->OooOO0O:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Llyiahf/vczjk/kw6;->OooOOO0:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Llyiahf/vczjk/kw6;->OooOOO:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Llyiahf/vczjk/kw6;->OooOOOO:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Llyiahf/vczjk/kw6;->OooOOo0:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Llyiahf/vczjk/kw6;->OooOOo:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Llyiahf/vczjk/kw6;->OooOOoo:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Llyiahf/vczjk/kw6;->OooOo00:Ljava/util/ArrayList;

    new-instance v0, Lnow/fortuitous/pm/PkgPool$newPackageMonitor$1;

    invoke-direct {v0, p0}, Lnow/fortuitous/pm/PkgPool$newPackageMonitor$1;-><init>(Llyiahf/vczjk/kw6;)V

    iput-object v0, p0, Llyiahf/vczjk/kw6;->OooOo0:Lnow/fortuitous/pm/PkgPool$newPackageMonitor$1;
    ...
    invoke-virtual {v0, p1, p2, v1, p3}, Lnow/fortuitous/pm/PackageMonitor;->OooO0o0(Landroid/content/Context;Landroid/os/UserHandle;Llyiahf/vczjk/nq2;Llyiahf/vczjk/uv6;)V
...
.method public final OooO00o(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Llyiahf/vczjk/kw6;->OooO00o:Landroid/content/Context;
    ...
    :try_start_0
    invoke-virtual {p0, v0}, Llyiahf/vczjk/kw6;->OooO0Oo(Landroid/content/pm/ApplicationInfo;)V
    :try_end_0
...
.method public final OooO0O0()V
    ...
    :cond_0
    iget-object v1, p0, Llyiahf/vczjk/kw6;->OooO0o:Ljava/util/HashSet;
    ...
    iget-object v3, p0, Llyiahf/vczjk/kw6;->OooO0o:Ljava/util/HashSet;
    ...
    invoke-static {v1, v0}, Llyiahf/vczjk/u81;->OooOo0(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final OooO0OO(Landroid/content/pm/ApplicationInfo;Landroid/content/pm/PackageInfo;IZ)Lgithub/tornaco/android/thanos/core/pm/AppInfo;
    ...
    iget-object v1, p0, Llyiahf/vczjk/kw6;->OooO0Oo:Landroid/content/pm/PackageManager;
    ...
    iget p1, p0, Llyiahf/vczjk/kw6;->OooO0O0:I
...
.method public final OooO0Oo(Landroid/content/pm/ApplicationInfo;)V
    ...
    invoke-static {v9, v10, v6}, Llyiahf/vczjk/z69;->Oooo0OO(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Z)Z

    move-result v10

    iget-object v11, p0, Llyiahf/vczjk/kw6;->OooO0oO:Ljava/util/HashSet;
    ...
    invoke-static {v10}, Llyiahf/vczjk/zsa;->o0ooOOo(Ljava/lang/String;)V
    ...
    invoke-static {v11, v10}, Llyiahf/vczjk/u81;->OooOo0(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v10, p0, Llyiahf/vczjk/kw6;->OooO0oo:Ljava/util/HashSet;
    ...
    :cond_3
    iget-object v10, p0, Llyiahf/vczjk/kw6;->OooO00o:Landroid/content/Context;

    iget v11, p0, Llyiahf/vczjk/kw6;->OooO0O0:I
    ...
    invoke-static {v9}, Llyiahf/vczjk/zsa;->Oooo0O0(Ljava/lang/String;)V
    ...
    iget-object v9, p0, Llyiahf/vczjk/kw6;->OooO0OO:Llyiahf/vczjk/uv6;

    invoke-virtual {v9, v8}, Llyiahf/vczjk/uv6;->getApplicationEnableState(Lgithub/tornaco/android/thanos/core/pm/Pkg;)Z

    move-result v8

    iget-object v9, p0, Llyiahf/vczjk/kw6;->OooO0o0:Ljava/util/HashSet;
    ...
    iget-object v11, p0, Llyiahf/vczjk/kw6;->OooO0o:Ljava/util/HashSet;
    ...
    :goto_0
    invoke-virtual {p0, p1, v10, v9, v8}, Llyiahf/vczjk/kw6;->OooO0OO(Landroid/content/pm/ApplicationInfo;Landroid/content/pm/PackageInfo;IZ)Lgithub/tornaco/android/thanos/core/pm/AppInfo;
    ...
    iget-object p1, p0, Llyiahf/vczjk/kw6;->OooOOOo:Ljava/util/ArrayList;
    ...
    iget-object p1, p0, Llyiahf/vczjk/kw6;->OooOOO0:Ljava/util/ArrayList;
    ...
    iget-object p1, p0, Llyiahf/vczjk/kw6;->OooO:Ljava/util/ArrayList;
    ...
    iget-object p1, p0, Llyiahf/vczjk/kw6;->OooOO0O:Ljava/util/ArrayList;
    ...
    iget-object p1, p0, Llyiahf/vczjk/kw6;->OooOO0:Ljava/util/ArrayList;
    ...
    invoke-static {p1, v9}, Llyiahf/vczjk/v34;->OooOoO0(Ljava/lang/Object;Ljava/lang/String;)V

    const-string v0, "github.tornaco.android.thanos.shortcut"

    invoke-static {p1, v0, v6}, Llyiahf/vczjk/g79;->Oooo00o(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    :cond_13
    iget-object p1, p0, Llyiahf/vczjk/kw6;->OooOOO:Ljava/util/ArrayList;
    ...
    :cond_14
    :goto_2
    iget-object p1, p0, Llyiahf/vczjk/kw6;->OooOOo0:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p1, p0, Llyiahf/vczjk/kw6;->OooOOo:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p1, p0, Llyiahf/vczjk/kw6;->OooOOoo:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final OooO0o0(Ljava/lang/String;)V
    ...
    invoke-direct {v0, v1, p0, p1}, Llyiahf/vczjk/gu6;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    iget-object v1, p0, Llyiahf/vczjk/kw6;->OooOOO:Ljava/util/ArrayList;

    new-instance v2, Llyiahf/vczjk/hw6;

    const/4 v3, 0x0

    invoke-direct {v2, v0, v3}, Llyiahf/vczjk/hw6;-><init>(Llyiahf/vczjk/gu6;I)V
    ...
    iget-object v1, p0, Llyiahf/vczjk/kw6;->OooOOo0:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {v1, p1}, Ljava/util/concurrent/ConcurrentHashMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v1, p0, Llyiahf/vczjk/kw6;->OooOOo:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {v1, p1}, Ljava/util/concurrent/ConcurrentHashMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object p1, p0, Llyiahf/vczjk/kw6;->OooOOO0:Ljava/util/ArrayList;

    new-instance v1, Llyiahf/vczjk/hw6;

    const/4 v2, 0x2

    invoke-direct {v1, v0, v2}, Llyiahf/vczjk/hw6;-><init>(Llyiahf/vczjk/gu6;I)V
