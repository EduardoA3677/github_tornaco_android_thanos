.class public abstract Llyiahf/vczjk/s80;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Llyiahf/vczjk/s80;->OooO0Oo:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, Llyiahf/vczjk/s80;->OooO0o0:Ljava/util/HashSet;

    iput-object p1, p0, Llyiahf/vczjk/s80;->OooO00o:Landroid/content/Context;

    const-string p1, "github.tornaco.android.thanos"

    iput-object p1, p0, Llyiahf/vczjk/s80;->OooO0OO:Ljava/lang/String;
...
.method public final OooO00o()V
    ...
    iget-object v1, p0, Llyiahf/vczjk/s80;->OooO0o0:Ljava/util/HashSet;

    :try_start_1
    invoke-direct {v0, v1}, Ljava/util/HashSet;-><init>(Ljava/util/Collection;)V

    iget-object v2, p0, Llyiahf/vczjk/s80;->OooO00o:Landroid/content/Context;
...
.method public final OooO0O0(Lgithub/tornaco/android/thanos/core/push/PushMessage;)V
    ...
    iget-object v9, p0, Llyiahf/vczjk/s80;->OooO00o:Landroid/content/Context;
    ...
    invoke-static {v7, v5}, Llyiahf/vczjk/c84;->OooOO0(Landroid/app/NotificationManager;Ljava/lang/String;)Landroid/app/NotificationChannel;
    ...
    :cond_1
    invoke-static {v5, v6}, Llyiahf/vczjk/cr;->OooO0O0(Ljava/lang/String;Ljava/lang/String;)Landroid/app/NotificationChannel;

    move-result-object v5

    invoke-static {v5}, Llyiahf/vczjk/c84;->OooOoo(Landroid/app/NotificationChannel;)V

    invoke-static {v5}, Llyiahf/vczjk/cr;->OooOO0o(Landroid/app/NotificationChannel;)V

    invoke-static {v5}, Llyiahf/vczjk/c84;->OooOooO(Landroid/app/NotificationChannel;)V

    new-array v6, v0, [J

    fill-array-data v6, :array_0

    invoke-static {v5, v6}, Llyiahf/vczjk/cr;->OooOOO0(Landroid/app/NotificationChannel;[J)V

    if-eqz v7, :cond_2

    invoke-static {v7, v5}, Llyiahf/vczjk/c84;->OooOo0(Landroid/app/NotificationManager;Landroid/app/NotificationChannel;)V
    ...
    :try_start_0
    iget-object v6, p0, Llyiahf/vczjk/s80;->OooO0O0:Landroid/content/Intent;

    if-nez v6, :cond_3

    iget-object v6, p0, Llyiahf/vczjk/s80;->OooO00o:Landroid/content/Context;
    ...
    iput-object v6, p0, Llyiahf/vczjk/s80;->OooO0O0:Landroid/content/Intent;
    ...
    invoke-static {v5}, Llyiahf/vczjk/zsa;->Ooooo0o(Ljava/lang/String;)V
    ...
    iget-object v5, p0, Llyiahf/vczjk/s80;->OooO0O0:Landroid/content/Intent;
    ...
    iget-object v7, p0, Llyiahf/vczjk/s80;->OooO00o:Landroid/content/Context;
    ...
    :try_start_1
    iget-object v11, p0, Llyiahf/vczjk/s80;->OooO00o:Landroid/content/Context;

    const-string v12, "\u5fae\u4fe1\u63a8\u9001"

    invoke-static {v11, v6, v12}, Llyiahf/vczjk/wd9;->OooO00o(Landroid/content/Context;Lgithub/tornaco/android/thanos/core/compat/NotificationCompat$Builder;Ljava/lang/String;)V
    :try_end_1
    ...
    iget-object v12, p0, Llyiahf/vczjk/s80;->OooO0OO:Ljava/lang/String;
    ...
    iget-boolean v7, p0, Llyiahf/vczjk/s80;->OooOO0O:Z
    ...
    iget-boolean v1, p0, Llyiahf/vczjk/s80;->OooOO0:Z
    ...
    iget-object v3, p0, Llyiahf/vczjk/s80;->OooO0OO:Ljava/lang/String;
    ...
    iget-object v2, p0, Llyiahf/vczjk/s80;->OooO0o0:Ljava/util/HashSet;
    ...
    iget-object v1, p0, Llyiahf/vczjk/s80;->OooO00o:Landroid/content/Context;
