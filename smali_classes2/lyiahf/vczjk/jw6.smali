.class public final Llyiahf/vczjk/jw6;
...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    iput-object v0, p0, Llyiahf/vczjk/jw6;->OooO00o:Lgithub/tornaco/android/thanos/core/Logger;
    ...
    iput-object v0, p0, Llyiahf/vczjk/jw6;->OooO0o0:Ljava/util/HashSet;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Llyiahf/vczjk/jw6;->OooO0o:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Llyiahf/vczjk/jw6;->OooO0oO:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Llyiahf/vczjk/jw6;->OooO0oo:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Llyiahf/vczjk/jw6;->OooO:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Llyiahf/vczjk/jw6;->OooOO0:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object v0, p0, Llyiahf/vczjk/jw6;->OooOO0O:Ljava/util/concurrent/atomic/AtomicBoolean;

    iput-object p1, p0, Llyiahf/vczjk/jw6;->OooO0O0:Landroid/content/Context;

    iput p2, p0, Llyiahf/vczjk/jw6;->OooO0OO:I

    invoke-virtual {p1}, Landroid/content/Context;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object p1

    iput-object p1, p0, Llyiahf/vczjk/jw6;->OooO0Oo:Landroid/content/pm/PackageManager;
...
.method public final OooO00o(Ljava/lang/String;)V
    ...
    sget-object v0, Llyiahf/vczjk/cma;->OooO0OO:Ljava/util/Set;

    invoke-interface {v0, p1}, Ljava/util/Set;->contains(Ljava/lang/Object;)Z

    move-result v0

    iget-object v1, p0, Llyiahf/vczjk/jw6;->OooO00o:Lgithub/tornaco/android/thanos/core/Logger;
    ...
    :cond_0
    iget-object v0, p0, Llyiahf/vczjk/jw6;->OooO0O0:Landroid/content/Context;

    iget v2, p0, Llyiahf/vczjk/jw6;->OooO0OO:I
    ...
    :try_start_0
    invoke-virtual {p0, v0}, Llyiahf/vczjk/jw6;->OooO0OO(Landroid/content/pm/ApplicationInfo;)V
    :try_end_0
    ...
    :try_start_1
    iget-object v0, p0, Llyiahf/vczjk/jw6;->OooO00o:Lgithub/tornaco/android/thanos/core/Logger;
...
.method public final OooO0O0(Landroid/content/pm/ApplicationInfo;Landroid/content/pm/PackageInfo;IZ)Lgithub/tornaco/android/thanos/core/pm/AppInfo;
    ...
    iget-object v1, p0, Llyiahf/vczjk/jw6;->OooO0Oo:Landroid/content/pm/PackageManager;
    ...
    iget p1, p0, Llyiahf/vczjk/jw6;->OooO0OO:I
...
.method public final OooO0OO(Landroid/content/pm/ApplicationInfo;)V
    ...
    :try_start_0
    invoke-virtual {p0, p1}, Llyiahf/vczjk/jw6;->OooO0Oo(Landroid/content/pm/ApplicationInfo;)Lgithub/tornaco/android/thanos/core/pm/AppInfo;
    ...
    iget-object v0, p0, Llyiahf/vczjk/jw6;->OooO0o:Ljava/util/ArrayList;
    ...
    iget-object p1, p0, Llyiahf/vczjk/jw6;->OooO0oO:Ljava/util/ArrayList;
    ...
    :cond_2
    iget-object p1, p0, Llyiahf/vczjk/jw6;->OooO0oo:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p1, p0, Llyiahf/vczjk/jw6;->OooO:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p1, p0, Llyiahf/vczjk/jw6;->OooOO0:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final OooO0Oo(Landroid/content/pm/ApplicationInfo;)Lgithub/tornaco/android/thanos/core/pm/AppInfo;
    ...
    iget-object v2, p0, Llyiahf/vczjk/jw6;->OooO0o0:Ljava/util/HashSet;
    ...
    sget-object v2, Llyiahf/vczjk/cma;->OooO0OO:Ljava/util/Set;
    ...
    :cond_2
    iget-object v2, p0, Llyiahf/vczjk/jw6;->OooO0O0:Landroid/content/Context;

    iget v3, p0, Llyiahf/vczjk/jw6;->OooO0OO:I
    ...
    iget-object v4, p0, Llyiahf/vczjk/jw6;->OooO00o:Lgithub/tornaco/android/thanos/core/Logger;
    ...
    :try_start_0
    sget-object v5, Llyiahf/vczjk/zx6;->OooO00o:Lgithub/tornaco/android/thanos/core/Logger;
    ...
    :cond_4
    invoke-virtual {p0, p1, v2, v0, v1}, Llyiahf/vczjk/jw6;->OooO0O0(Landroid/content/pm/ApplicationInfo;Landroid/content/pm/PackageInfo;IZ)Lgithub/tornaco/android/thanos/core/pm/AppInfo;
