.class public Llyiahf/vczjk/yw6;
.super Ljava/lang/Object;
.source "SourceFile"


# static fields
.field public static volatile OooO00o:Llyiahf/vczjk/yw6;
...
.method static constructor <clinit>()V
    ...
    sget-object v0, Llyiahf/vczjk/ud;->OooO0O0:Ljava/util/Map;
    ...
    sget-object v5, Llyiahf/vczjk/ud;->OooO00o:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    sget-object v3, Llyiahf/vczjk/vd;->OooO00o:Llyiahf/vczjk/vd;
    ...
    :cond_3
    sget-boolean v0, Llyiahf/vczjk/i9;->OooO0Oo:Z

    if-eqz v0, :cond_4

    new-instance v0, Llyiahf/vczjk/i9;

    invoke-direct {v0}, Llyiahf/vczjk/i9;-><init>()V
    ...
    sget-boolean v0, Llyiahf/vczjk/ue;->OooO0o0:Z

    if-eqz v0, :cond_5

    new-instance v1, Llyiahf/vczjk/ue;

    invoke-direct {v1}, Llyiahf/vczjk/ue;-><init>()V
    ...
    new-instance v0, Llyiahf/vczjk/wi1;

    invoke-direct {v0}, Llyiahf/vczjk/wi1;-><init>()V
    ...
    sget-boolean v0, Llyiahf/vczjk/og0;->OooO0Oo:Z

    if-eqz v0, :cond_9

    new-instance v0, Llyiahf/vczjk/og0;

    invoke-direct {v0}, Llyiahf/vczjk/og0;-><init>()V
    ...
    sget-boolean v0, Llyiahf/vczjk/wc6;->OooO0Oo:Z

    if-eqz v0, :cond_b

    new-instance v0, Llyiahf/vczjk/wc6;

    invoke-direct {v0}, Llyiahf/vczjk/wc6;-><init>()V
    ...
    :cond_c
    sget-boolean v0, Llyiahf/vczjk/s74;->OooO0OO:Z

    if-eqz v0, :cond_d

    new-instance v0, Llyiahf/vczjk/s74;
    ...
    new-instance v6, Llyiahf/vczjk/r74;
    ...
    invoke-static {v10, v0}, Llyiahf/vczjk/v34;->OooOoO0(Ljava/lang/Object;Ljava/lang/String;)V

    const-string v0, "serverProviderClass"

    invoke-static {v11, v0}, Llyiahf/vczjk/v34;->OooOoO0(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-direct/range {v6 .. v11}, Llyiahf/vczjk/r74;-><init>(Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;Ljava/lang/Class;Ljava/lang/Class;)V
    :try_end_1
    ...
    :cond_10
    new-instance v0, Llyiahf/vczjk/yw6;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    :cond_11
    :goto_9
    sput-object v0, Llyiahf/vczjk/yw6;->OooO00o:Llyiahf/vczjk/yw6;
    ...
    sput-object v0, Llyiahf/vczjk/yw6;->OooO0O0:Ljava/util/logging/Logger;
...
.method public static OooO(ILjava/lang/String;Ljava/lang/Throwable;)V
    ...
    :goto_0
    sget-object v0, Llyiahf/vczjk/yw6;->OooO0O0:Ljava/util/logging/Logger;
...
.method public OooO0O0(Ljavax/net/ssl/X509TrustManager;)Llyiahf/vczjk/zsa;
    .locals 1

    new-instance v0, Llyiahf/vczjk/k90;

    invoke-virtual {p0, p1}, Llyiahf/vczjk/yw6;->OooO0OO(Ljavax/net/ssl/X509TrustManager;)Llyiahf/vczjk/e1a;
...
.method public OooO0OO(Ljavax/net/ssl/X509TrustManager;)Llyiahf/vczjk/e1a;
    .locals 2

    new-instance v0, Llyiahf/vczjk/ja0;
    ...
    invoke-direct {v0, p1}, Llyiahf/vczjk/ja0;-><init>([Ljava/security/cert/X509Certificate;)V
...
.method public OooOO0(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {v0, p2, p1}, Llyiahf/vczjk/yw6;->OooO(ILjava/lang/String;Ljava/lang/Throwable;)V
...
.method public OooOO0o(Ljavax/net/ssl/X509TrustManager;)Ljavax/net/ssl/SSLSocketFactory;
    ...
    :try_start_0
    invoke-virtual {p0}, Llyiahf/vczjk/yw6;->OooOO0O()Ljavax/net/ssl/SSLContext;
