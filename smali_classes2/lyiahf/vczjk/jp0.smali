.class public abstract Llyiahf/vczjk/jp0;
...
.method public constructor <init>(Ljava/lang/reflect/Member;Ljava/lang/reflect/Type;Ljava/lang/Class;[Ljava/lang/reflect/Type;)V
    ...
    iput-object p1, p0, Llyiahf/vczjk/jp0;->OooO00o:Ljava/lang/reflect/Member;

    iput-object p2, p0, Llyiahf/vczjk/jp0;->OooO0O0:Ljava/lang/reflect/Type;

    iput-object p3, p0, Llyiahf/vczjk/jp0;->OooO0OO:Ljava/lang/Class;

    if-eqz p3, :cond_0

    new-instance p1, Llyiahf/vczjk/eh1;

    const/4 p2, 0x2

    invoke-direct {p1, p2}, Llyiahf/vczjk/eh1;-><init>(I)V

    invoke-virtual {p1, p3}, Llyiahf/vczjk/eh1;->OooO00o(Ljava/lang/Object;)V

    invoke-virtual {p1, p4}, Llyiahf/vczjk/eh1;->OooO0O0(Ljava/lang/Object;)V

    iget-object p1, p1, Llyiahf/vczjk/eh1;->OooO00o:Ljava/util/ArrayList;
    ...
    :cond_0
    invoke-static {p4}, Llyiahf/vczjk/sy;->o0000oO([Ljava/lang/Object;)Ljava/util/List;

    move-result-object p1

    :goto_0
    iput-object p1, p0, Llyiahf/vczjk/jp0;->OooO0Oo:Ljava/util/List;
...
.method public final OooO0O0()Ljava/util/List;
    ...
    iget-object v0, p0, Llyiahf/vczjk/jp0;->OooO0Oo:Ljava/util/List;
...
.method public final OooOOoo()Ljava/lang/reflect/Type;
    ...
    iget-object v0, p0, Llyiahf/vczjk/jp0;->OooO0O0:Ljava/lang/reflect/Type;
