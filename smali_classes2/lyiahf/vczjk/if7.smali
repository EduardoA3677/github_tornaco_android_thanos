.class public final Llyiahf/vczjk/if7;
...
.field public OooOO0o:Llyiahf/vczjk/mla;

.field public final OooOOO:Llyiahf/vczjk/ff7;

.field public final OooOOO0:Llyiahf/vczjk/df7;

.field public final OooOOOO:Llyiahf/vczjk/gf7;

.field public final OooOOOo:Llyiahf/vczjk/hf7;
...
.method public constructor <init>(Llyiahf/vczjk/fo9;)V
    ...
    new-instance p1, Llyiahf/vczjk/df7;

    invoke-direct {p1}, Lgithub/tornaco/android/thanos/core/pref/IPrefChangeListener$Stub;-><init>()V

    iput-object p1, p0, Llyiahf/vczjk/if7;->OooOOO0:Llyiahf/vczjk/df7;

    new-instance p1, Llyiahf/vczjk/ff7;

    invoke-direct {p1, p0}, Llyiahf/vczjk/ff7;-><init>(Llyiahf/vczjk/if7;)V

    iput-object p1, p0, Llyiahf/vczjk/if7;->OooOOO:Llyiahf/vczjk/ff7;

    new-instance p1, Llyiahf/vczjk/gf7;

    invoke-direct {p1, p0}, Llyiahf/vczjk/gf7;-><init>(Llyiahf/vczjk/if7;)V

    iput-object p1, p0, Llyiahf/vczjk/if7;->OooOOOO:Llyiahf/vczjk/gf7;

    new-instance p1, Llyiahf/vczjk/hf7;

    invoke-direct {p1, p0}, Llyiahf/vczjk/hf7;-><init>(Llyiahf/vczjk/if7;)V

    iput-object p1, p0, Llyiahf/vczjk/if7;->OooOOOo:Llyiahf/vczjk/hf7;
...
.method public final OooO()Landroid/content/Context;
    ...
    iget-object v0, p0, Llyiahf/vczjk/if7;->OooOO0:Landroid/content/Context;
...
.method public final OooOO0o(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Llyiahf/vczjk/if7;->OooOO0:Landroid/content/Context;
    ...
    iput-object p1, p0, Llyiahf/vczjk/if7;->OooOO0O:Landroid/os/Handler;
...
.method public final OooOOOo()V
    ...
    :cond_0
    iget-object v1, p0, Llyiahf/vczjk/if7;->OooOO0O:Landroid/os/Handler;
    ...
    :cond_1
    new-instance v1, Llyiahf/vczjk/mla;

    invoke-direct {v1, v0}, Llyiahf/vczjk/s80;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Llyiahf/vczjk/if7;->OooOO0o:Llyiahf/vczjk/mla;

    iget-object v0, p0, Llyiahf/vczjk/aq9;->OooO:Llyiahf/vczjk/fo9;

    iget-object v2, v0, Llyiahf/vczjk/fo9;->OooOOOO:Llyiahf/vczjk/o27;

    iget-object v2, v2, Llyiahf/vczjk/o27;->OooOO0:Llyiahf/vczjk/mi;

    const-string v3, "plugin.push.message.delegate.server.channel_enabled_com.tencent.mm"

    const/4 v4, 0x0

    invoke-virtual {v2, v3, v4}, Llyiahf/vczjk/mi;->OooOO0(Ljava/lang/String;Z)Z

    move-result v2

    iput-boolean v2, v1, Llyiahf/vczjk/s80;->OooO0o:Z

    iget-object v1, p0, Llyiahf/vczjk/if7;->OooOO0o:Llyiahf/vczjk/mla;
    ...
    iput-boolean v2, v1, Llyiahf/vczjk/s80;->OooOO0:Z

    iget-object v1, p0, Llyiahf/vczjk/if7;->OooOO0o:Llyiahf/vczjk/mla;

    iget-object v2, v0, Llyiahf/vczjk/fo9;->OooOOOO:Llyiahf/vczjk/o27;

    iget-object v3, v2, Llyiahf/vczjk/o27;->OooOO0:Llyiahf/vczjk/mi;

    const-string v5, "plugin.push.message.delegate.server.channel_n_vibrate_enabled_com.tencent.mm"

    invoke-virtual {v3, v5, v4}, Llyiahf/vczjk/mi;->OooOO0(Ljava/lang/String;Z)Z

    move-result v3

    iput-boolean v3, v1, Llyiahf/vczjk/s80;->OooOO0O:Z
    ...
    iput-boolean v3, v1, Llyiahf/vczjk/s80;->OooO:Z
    ...
    iput-boolean v3, v1, Llyiahf/vczjk/s80;->OooO0oO:Z
    ...
    iget-object v3, v0, Llyiahf/vczjk/fo9;->OooOo00:Llyiahf/vczjk/mf7;

    invoke-virtual {v3, v1}, Llyiahf/vczjk/mf7;->registerChannel(Lgithub/tornaco/android/thanos/core/push/PushChannel;)V

    invoke-virtual {v1}, Lgithub/tornaco/android/thanos/core/push/PushChannel;->getChannelId()Ljava/lang/String;

    move-result-object v1

    iget-object v4, p0, Llyiahf/vczjk/if7;->OooOOOO:Llyiahf/vczjk/gf7;

    invoke-virtual {v3, v1, v4}, Llyiahf/vczjk/mf7;->registerChannelHandler(Ljava/lang/String;Lgithub/tornaco/android/thanos/core/push/IChannelHandler;)V

    iget-object v1, p0, Llyiahf/vczjk/if7;->OooOOO0:Llyiahf/vczjk/df7;
    ...
    iget-object v1, p0, Llyiahf/vczjk/if7;->OooOOO:Llyiahf/vczjk/ff7;
    ...
    iget-object v1, p0, Llyiahf/vczjk/if7;->OooOOOo:Llyiahf/vczjk/hf7;
...
.method public final mockWechatMessage()V
    ...
    invoke-virtual {v1, v0}, Llyiahf/vczjk/a;->checkBroadcastingIntent(Landroid/content/Intent;)Z
...
.method public final onHookBroadcastPerformResult(Landroid/content/Intent;I)I
    ...
    :cond_0
    sget-object v0, Llyiahf/vczjk/of7;->OooO00o:[Ljava/lang/Object;
    ...
    invoke-static {v1, p1}, Llyiahf/vczjk/u81;->OooOo(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, v2}, Llyiahf/vczjk/mi;->OooOO0(Ljava/lang/String;Z)Z
    ...
    invoke-static {p2, p1}, Llyiahf/vczjk/u81;->OooOo0(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final setSkipIfWeChatAppRunningEnabled(Z)V
    ...
    iget-object v0, p0, Llyiahf/vczjk/if7;->OooOO0o:Llyiahf/vczjk/mla;

    iput-boolean p1, v0, Llyiahf/vczjk/s80;->OooO0oo:Z
...
.method public final setWeChatEnabled(Z)V
    ...
    iput-boolean p1, v0, Llyiahf/vczjk/s80;->OooO0o:Z
...
.method public final setWechatContentEnabled(Z)V
    ...
    iput-boolean p1, v0, Llyiahf/vczjk/s80;->OooO:Z
...
.method public final setWechatSoundEnabled(Z)V
    ...
    iput-boolean p1, v0, Llyiahf/vczjk/s80;->OooOO0:Z
...
.method public final setWechatVibrateEnabled(Z)V
    ...
    iput-boolean p1, v0, Llyiahf/vczjk/s80;->OooOO0O:Z
