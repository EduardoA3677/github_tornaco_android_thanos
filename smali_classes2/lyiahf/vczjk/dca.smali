.class public final Llyiahf/vczjk/dca;
...
# direct methods
.method public constructor <init>(Llyiahf/vczjk/rf3;Llyiahf/vczjk/yf4;Ljava/lang/String;Ljava/util/List;)V
    .locals 4
    ...
    invoke-virtual {p2, v0, p3}, Llyiahf/vczjk/yf4;->OooO0oO(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/reflect/Method;

    move-result-object v0

    invoke-static {v0}, Llyiahf/vczjk/v34;->OooOo0o(Ljava/lang/Object;)V

    iput-object v0, p0, Llyiahf/vczjk/dca;->OooO00o:Ljava/lang/reflect/Method;
    ...
    invoke-static {p3, v1}, Llyiahf/vczjk/z69;->Ooooo00(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p3

    invoke-virtual {v0, p3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-interface {p2}, Llyiahf/vczjk/tx0;->OooO0Oo()Ljava/lang/Class;

    move-result-object p3

    invoke-static {p3}, Llyiahf/vczjk/rl7;->OooO0O0(Ljava/lang/Class;)Ljava/lang/String;
    ...
    iput-object p2, p0, Llyiahf/vczjk/dca;->OooO0O0:Ljava/lang/reflect/Method;

    new-instance p2, Ljava/util/ArrayList;

    const/16 p3, 0xa

    invoke-static {p4, p3}, Llyiahf/vczjk/f21;->o000oOoO(Ljava/lang/Iterable;I)I
    ...
    check-cast v1, Llyiahf/vczjk/ko6;
    ...
    invoke-static {v1}, Llyiahf/vczjk/qu6;->OooOO0(Llyiahf/vczjk/dp8;)Ljava/util/ArrayList;

    move-result-object v3

    if-nez v3, :cond_0

    invoke-static {v1}, Llyiahf/vczjk/qu6;->OooOo0O(Llyiahf/vczjk/uk4;)Ljava/lang/Class;

    move-result-object v1

    if-eqz v1, :cond_1

    invoke-static {v1, p1}, Llyiahf/vczjk/qu6;->OooO(Ljava/lang/Class;Llyiahf/vczjk/eo0;)Ljava/lang/reflect/Method;
    ...
    :cond_2
    iput-object p2, p0, Llyiahf/vczjk/dca;->OooO0OO:Ljava/util/ArrayList;
    ...
    invoke-interface {v0}, Llyiahf/vczjk/gca;->getType()Llyiahf/vczjk/uk4;
    ...
    iget-object v3, p0, Llyiahf/vczjk/dca;->OooO0OO:Ljava/util/ArrayList;
    ...
    invoke-static {p4}, Llyiahf/vczjk/r02;->OooOo(Ljava/lang/Object;)Ljava/util/List;
    ...
    :cond_6
    iput-object p1, p0, Llyiahf/vczjk/dca;->OooO0Oo:Ljava/util/ArrayList;
    ...
    invoke-static {p3, p2}, Llyiahf/vczjk/j21;->OoooOo0(Ljava/lang/Iterable;Ljava/util/Collection;)V

    goto :goto_4

    :cond_7
    iput-object p2, p0, Llyiahf/vczjk/dca;->OooO0o0:Ljava/util/ArrayList;
...
.method public final OooO0O0()Ljava/util/List;
    ...
    iget-object v0, p0, Llyiahf/vczjk/dca;->OooO0o0:Ljava/util/ArrayList;
...
.method public final OooO0Oo([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v0, p0, Llyiahf/vczjk/dca;->OooO0OO:Ljava/util/ArrayList;
    ...
    :cond_2
    invoke-static {v6, p1}, Llyiahf/vczjk/j21;->OoooOo0(Ljava/lang/Iterable;Ljava/util/Collection;)V
    ...
    iget-object v1, p0, Llyiahf/vczjk/dca;->OooO00o:Ljava/lang/reflect/Method;
    ...
    iget-object v0, p0, Llyiahf/vczjk/dca;->OooO0O0:Ljava/lang/reflect/Method;
