.class public final synthetic Llyiahf/vczjk/lu;
...
.method public synthetic constructor <init>(Lgithub/tornaco/android/thanos/common/CommonAppListFilterActivity;I)V
    ...
    iput p2, p0, Llyiahf/vczjk/lu;->OooO00o:I

    iput-object p1, p0, Llyiahf/vczjk/lu;->OooO0O0:Lgithub/tornaco/android/thanos/common/CommonAppListFilterActivity;
...
.method public final OooO00o(Lgithub/tornaco/android/thanos/core/pm/AppInfo;)V
    ...
    iget-object v2, p0, Llyiahf/vczjk/lu;->OooO0O0:Lgithub/tornaco/android/thanos/common/CommonAppListFilterActivity;

    iget v3, p0, Llyiahf/vczjk/lu;->OooO00o:I
    ...
    :cond_1
    new-instance v4, Llyiahf/vczjk/kd5;

    invoke-direct {v4, v2}, Llyiahf/vczjk/kd5;-><init>(Landroid/content/Context;)V

    invoke-virtual {p1}, Lgithub/tornaco/android/thanos/core/pm/AppInfo;->getAppLabel()Ljava/lang/String;

    move-result-object v5

    iget-object v6, v4, Llyiahf/vczjk/w3;->OooOOO:Ljava/lang/Object;

    check-cast v6, Llyiahf/vczjk/s3;

    iput-object v5, v6, Llyiahf/vczjk/s3;->OooO0Oo:Ljava/lang/CharSequence;

    new-instance v5, Llyiahf/vczjk/x0;

    const/4 v7, 0x7

    invoke-direct {v5, v7, v2, p1}, Llyiahf/vczjk/x0;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    invoke-virtual {v4, v3, v1, v5}, Llyiahf/vczjk/kd5;->OooOo0O([Ljava/lang/CharSequence;ILandroid/content/DialogInterface$OnClickListener;)V

    iput-boolean v0, v6, Llyiahf/vczjk/s3;->OooOOO0:Z

    invoke-virtual {v4}, Llyiahf/vczjk/w3;->OooOOOO()Llyiahf/vczjk/x3;
    ...
    new-instance v3, Llyiahf/vczjk/kd5;

    invoke-direct {v3, v2}, Llyiahf/vczjk/kd5;-><init>(Landroid/content/Context;)V

    invoke-virtual {p1}, Lgithub/tornaco/android/thanos/core/pm/AppInfo;->getAppLabel()Ljava/lang/String;

    move-result-object v4

    iget-object v5, v3, Llyiahf/vczjk/w3;->OooOOO:Ljava/lang/Object;
    ...
    new-instance v5, Llyiahf/vczjk/e92;

    invoke-direct {v5, v2, p1, v1}, Llyiahf/vczjk/e92;-><init>(Lnow/fortuitous/thanos/start/DetailedStartRecordsActivity;Lgithub/tornaco/android/thanos/core/pm/AppInfo;I)V

    invoke-virtual {v3, v4, v5}, Llyiahf/vczjk/kd5;->OooOo00(ILandroid/content/DialogInterface$OnClickListener;)V
    ...
    new-instance v4, Llyiahf/vczjk/e92;

    invoke-direct {v4, v2, p1, v0}, Llyiahf/vczjk/e92;-><init>(Lnow/fortuitous/thanos/start/DetailedStartRecordsActivity;Lgithub/tornaco/android/thanos/core/pm/AppInfo;I)V

    invoke-virtual {v3, v1, v4}, Llyiahf/vczjk/kd5;->OooOOo(ILandroid/content/DialogInterface$OnClickListener;)V

    invoke-virtual {v3}, Llyiahf/vczjk/w3;->OooOOOO()Llyiahf/vczjk/x3;
    ...
    invoke-static {v2, p1, v0}, Llyiahf/vczjk/bua;->OoooO00(Landroid/content/Context;Ljava/lang/Class;Landroid/os/Bundle;)V
