.class public final synthetic Llyiahf/vczjk/ts;
...
.method public synthetic constructor <init>(Lnow/fortuitous/thanos/apps/AppDetailsActivity;I)V
    ...
    iput p2, p0, Llyiahf/vczjk/ts;->OooOOO0:I

    iput-object p1, p0, Llyiahf/vczjk/ts;->OooOOO:Lnow/fortuitous/thanos/apps/AppDetailsActivity;
...
.method public final OooO0o(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v1, p0, Llyiahf/vczjk/ts;->OooOOO:Lnow/fortuitous/thanos/apps/AppDetailsActivity;

    const/4 v2, 0x1

    iget v3, p0, Llyiahf/vczjk/ts;->OooOOO0:I
    ...
    iget-object v1, v1, Lnow/fortuitous/thanos/apps/AppDetailsActivity;->OoooO0:Llyiahf/vczjk/cp8;

    invoke-virtual {v1, v3, v2, p1}, Llyiahf/vczjk/cp8;->OooO0OO(ILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v2}, Llyiahf/vczjk/kd5;->OooOo0o(I)V

    sget v2, Lgithub/tornaco/android/thanos/res/R$string;->module_donate_donated_available_message:I

    invoke-virtual {p1, v2}, Llyiahf/vczjk/kd5;->OooOOo0(I)V

    const/high16 v2, 0x1040000

    invoke-virtual {p1, v2, v0}, Llyiahf/vczjk/kd5;->OooOOo(ILandroid/content/DialogInterface$OnClickListener;)V
    ...
    invoke-direct {v3, v1, v4}, Llyiahf/vczjk/w0;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {p1, v2, v3}, Llyiahf/vczjk/kd5;->OooOo00(ILandroid/content/DialogInterface$OnClickListener;)V
    ...
    :cond_2
    new-instance v5, Llyiahf/vczjk/kd5;

    invoke-direct {v5, v1}, Llyiahf/vczjk/kd5;-><init>(Landroid/content/Context;)V

    sget v7, Lgithub/tornaco/android/thanos/res/R$string;->pref_action_apply_config_template:I

    invoke-virtual {v5, v7}, Llyiahf/vczjk/kd5;->OooOo0o(I)V
    ...
    new-instance v6, Llyiahf/vczjk/a1;

    invoke-direct {v6, v1, p1, v2, v4}, Llyiahf/vczjk/a1;-><init>(Ljava/lang/Object;Ljava/lang/Object;ILjava/lang/Object;)V

    iget-object p1, v5, Llyiahf/vczjk/w3;->OooOOO:Ljava/lang/Object;

    check-cast p1, Llyiahf/vczjk/s3;

    iput-object v3, p1, Llyiahf/vczjk/s3;->OooOOOo:[Ljava/lang/CharSequence;

    iput-object v6, p1, Llyiahf/vczjk/s3;->OooOOo:Landroid/content/DialogInterface$OnClickListener;
