...
.method public static synthetic OooO00o(Ljava/lang/String;)Llyiahf/vczjk/z8a;
    ...
    invoke-static {p0}, Lgithub/tornaco/android/thanos/services/xposed/hooks/s/pm/UserTypeFactoryHook;->hookLockSettings$lambda$11$lambda$9(Ljava/lang/String;)Llyiahf/vczjk/z8a;
...
.method public static synthetic OooO0O0(Lde/robv/android/xposed/XC_MethodHook$MethodHookParam;)Llyiahf/vczjk/z8a;
    ...
    invoke-static {p0}, Lgithub/tornaco/android/thanos/services/xposed/hooks/s/pm/UserTypeFactoryHook;->hookLockSettings$lambda$11$lambda$10(Lde/robv/android/xposed/XC_MethodHook$MethodHookParam;)Llyiahf/vczjk/z8a;
...
.method public static synthetic OooO0OO(Lde/robv/android/xposed/XC_MethodHook$MethodHookParam;)Llyiahf/vczjk/z8a;
    ...
    invoke-static {p0}, Lgithub/tornaco/android/thanos/services/xposed/hooks/s/pm/UserTypeFactoryHook;->hookUserTypeFactory2$lambda$3$lambda$2(Lde/robv/android/xposed/XC_MethodHook$MethodHookParam;)Llyiahf/vczjk/z8a;
...
.method public static synthetic OooO0Oo(Ljava/lang/String;)Llyiahf/vczjk/z8a;
    ...
    invoke-static {p0}, Lgithub/tornaco/android/thanos/services/xposed/hooks/s/pm/UserTypeFactoryHook;->hookUserTypeFactory2$lambda$3$lambda$0(Ljava/lang/String;)Llyiahf/vczjk/z8a;
...
.method public static synthetic OooO0o(Lde/robv/android/xposed/XC_MethodHook$MethodHookParam;)Llyiahf/vczjk/z8a;
    .locals 0

    invoke-static {p0}, Lgithub/tornaco/android/thanos/services/xposed/hooks/s/pm/UserTypeFactoryHook;->hookLockSettings$lambda$7$lambda$6(Lde/robv/android/xposed/XC_MethodHook$MethodHookParam;)Llyiahf/vczjk/z8a;
...
.method public static synthetic OooO0o0(Ljava/lang/String;)Llyiahf/vczjk/z8a;
    ...
    invoke-static {p0}, Lgithub/tornaco/android/thanos/services/xposed/hooks/s/pm/UserTypeFactoryHook;->hookLockSettings$lambda$7$lambda$5(Ljava/lang/String;)Llyiahf/vczjk/z8a;
...
.method private final hookLockSettings(Lgithub/tornaco/android/thanos/services/xposed/ISystemServerLoaded$Param;)V
    ...
    new-instance v4, Llyiahf/vczjk/by9;

    const/4 v5, 0x4

    invoke-direct {v4, v5}, Llyiahf/vczjk/by9;-><init>(I)V
    ...
    invoke-static {v2, v3, v4, v5}, Lgithub/tornaco/android/thanos/services/xposed/HooksKt;->afterMethod(Ljava/lang/Class;Ljava/lang/String;Llyiahf/vczjk/oe3;Llyiahf/vczjk/oe3;)V
    :try_end_0
    ...
    invoke-static {v4, v5, v2}, Llyiahf/vczjk/zsa;->Oooo0o(Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/Throwable;)V
    ...
    new-instance v2, Llyiahf/vczjk/by9;

    const/4 v5, 0x6

    invoke-direct {v2, v5}, Llyiahf/vczjk/by9;-><init>(I)V
    ...
    invoke-static {p1, v1, v2, v5}, Lgithub/tornaco/android/thanos/services/xposed/HooksKt;->afterMethod(Ljava/lang/Class;Ljava/lang/String;Llyiahf/vczjk/oe3;Llyiahf/vczjk/oe3;)V
    :try_end_1
    ...
    invoke-static {v4, v0, p1}, Llyiahf/vczjk/zsa;->Oooo0o(Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/Throwable;)V

    :cond_1
    return-void
.end method

.method private static final hookLockSettings$lambda$11$lambda$10(Lde/robv/android/xposed/XC_MethodHook$MethodHookParam;)Llyiahf/vczjk/z8a;
    .locals 7
    ...
    invoke-static {p0}, Llyiahf/vczjk/cp7;->Oooo0o(Ljava/lang/Throwable;)Ljava/lang/String;
...
.method private static final hookLockSettings$lambda$11$lambda$9(Ljava/lang/String;)Llyiahf/vczjk/z8a;
    .locals 1
...
.method private static final hookLockSettings$lambda$7$lambda$5(Ljava/lang/String;)Llyiahf/vczjk/z8a;
    .locals 1
...
.method private static final hookLockSettings$lambda$7$lambda$6(Lde/robv/android/xposed/XC_MethodHook$MethodHookParam;)Llyiahf/vczjk/z8a;
    .locals 7
...
.method private final hookUserTypeFactory2(Lgithub/tornaco/android/thanos/services/xposed/ISystemServerLoaded$Param;)V
    ...
    new-instance v1, Llyiahf/vczjk/by9;

    const/4 v2, 0x2

    invoke-direct {v1, v2}, Llyiahf/vczjk/by9;-><init>(I)V

    new-instance v2, Llyiahf/vczjk/by9;

    const/4 v3, 0x3

    invoke-direct {v2, v3}, Llyiahf/vczjk/by9;-><init>(I)V
...
.method private static final hookUserTypeFactory2$lambda$3$lambda$0(Ljava/lang/String;)Llyiahf/vczjk/z8a;
    .locals 1
...
.method private static final hookUserTypeFactory2$lambda$3$lambda$2(Lde/robv/android/xposed/XC_MethodHook$MethodHookParam;)Llyiahf/vczjk/z8a;
    .locals 5
