...
.method public static synthetic OooO00o(Ljava/lang/String;)Llyiahf/vczjk/z8a;
    .locals 0

    invoke-static {p0}, Lgithub/tornaco/android/thanos/services/xposed/hooks/s/pm/ShortcutHook;->hookStartShortcut$lambda$17$lambda$15(Ljava/lang/String;)Llyiahf/vczjk/z8a;
...
.method public static synthetic OooO0O0(Lde/robv/android/xposed/XC_MethodHook$MethodHookParam;)Llyiahf/vczjk/z8a;
    .locals 0

    invoke-static {p0}, Lgithub/tornaco/android/thanos/services/xposed/hooks/s/pm/ShortcutHook;->hookLocalService$lambda$6$lambda$5(Lde/robv/android/xposed/XC_MethodHook$MethodHookParam;)Llyiahf/vczjk/z8a;
...
.method public static synthetic OooO0OO(Lde/robv/android/xposed/XC_MethodHook$MethodHookParam;)Llyiahf/vczjk/z8a;
    .locals 0

    invoke-static {p0}, Lgithub/tornaco/android/thanos/services/xposed/hooks/s/pm/ShortcutHook;->hookLauncherApps$lambda$13$lambda$12(Lde/robv/android/xposed/XC_MethodHook$MethodHookParam;)Llyiahf/vczjk/z8a;
...
.method public static synthetic OooO0Oo(Ljava/lang/String;)Llyiahf/vczjk/z8a;
    .locals 0

    invoke-static {p0}, Lgithub/tornaco/android/thanos/services/xposed/hooks/s/pm/ShortcutHook;->hookLocalService$lambda$6$lambda$0(Ljava/lang/String;)Llyiahf/vczjk/z8a;
...
.method public static synthetic OooO0o0(Ljava/lang/String;)Llyiahf/vczjk/z8a;
    .locals 0

    invoke-static {p0}, Lgithub/tornaco/android/thanos/services/xposed/hooks/s/pm/ShortcutHook;->hookLauncherApps$lambda$13$lambda$8(Ljava/lang/String;)Llyiahf/vczjk/z8a;
...
.method public static synthetic OooO0oo(Lde/robv/android/xposed/XC_MethodHook$MethodHookParam;)Llyiahf/vczjk/z8a;
    ...
    invoke-static {p0}, Lgithub/tornaco/android/thanos/services/xposed/hooks/s/pm/ShortcutHook;->hookStartShortcut$lambda$17$lambda$16(Lde/robv/android/xposed/XC_MethodHook$MethodHookParam;)Llyiahf/vczjk/z8a;
...
.method private final hookLauncherApps(Lgithub/tornaco/android/thanos/services/xposed/ISystemServerLoaded$Param;)V
    ...
    invoke-static {p1, v0, v1}, Lgithub/tornaco/android/thanos/services/xposed/HooksKt;->afterMethod(Ljava/lang/reflect/Method;Llyiahf/vczjk/oe3;Llyiahf/vczjk/oe3;)V
...
.method private static final hookLauncherApps$lambda$13$lambda$12(Lde/robv/android/xposed/XC_MethodHook$MethodHookParam;)Llyiahf/vczjk/z8a;
    .locals 8
    ...
    new-instance v6, Llyiahf/vczjk/ym8;

    const/4 v0, 0x0

    invoke-direct {v6, v0}, Llyiahf/vczjk/ym8;-><init>(I)V
    ...
    invoke-static {v3}, Llyiahf/vczjk/zm8;->OooO0O0(Ljava/lang/Object;)Landroid/content/pm/ShortcutInfo;

    move-result-object v4

    sget-object v5, Llyiahf/vczjk/he0;->OooO00o:Llyiahf/vczjk/fo9;

    iget-object v5, v5, Llyiahf/vczjk/fo9;->OooOO0O:Llyiahf/vczjk/uv6;

    invoke-virtual {v5}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v4}, Llyiahf/vczjk/al2;->OooO(Landroid/content/pm/ShortcutInfo;)Ljava/lang/String;
    ...
    invoke-virtual {v5, v6}, Llyiahf/vczjk/uv6;->isPkgShortcutsBlockerEnabled(Lgithub/tornaco/android/thanos/core/pm/Pkg;)Z

    move-result v6

    if-eqz v6, :cond_2

    iget-object v5, v5, Llyiahf/vczjk/uv6;->Oooo0o0:Llyiahf/vczjk/fn8;

    if-eqz v5, :cond_2

    invoke-virtual {v5, v4}, Llyiahf/vczjk/fn8;->OooO00o(Landroid/content/pm/ShortcutInfo;)Z
    ...
    invoke-static {v2}, Llyiahf/vczjk/zm8;->OooO0O0(Ljava/lang/Object;)Landroid/content/pm/ShortcutInfo;
...
.method private static final hookLauncherApps$lambda$13$lambda$12$lambda$9(Landroid/content/pm/ShortcutInfo;)Ljava/lang/CharSequence;
    ...
    invoke-static {p0}, Llyiahf/vczjk/al2;->OooO(Landroid/content/pm/ShortcutInfo;)Ljava/lang/String;
...
.method private static final hookLauncherApps$lambda$13$lambda$8(Ljava/lang/String;)Llyiahf/vczjk/z8a;
    .locals 1
...
.method private final hookLocalService(Lgithub/tornaco/android/thanos/services/xposed/ISystemServerLoaded$Param;)V
    ...
    new-instance v2, Llyiahf/vczjk/xm8;

    const/4 v3, 0x3

    invoke-direct {v2, v3}, Llyiahf/vczjk/xm8;-><init>(I)V

    invoke-static {p1, v0, v1, v2}, Lgithub/tornaco/android/thanos/services/xposed/HooksKt;->afterMethod(Ljava/lang/Class;Ljava/lang/String;Llyiahf/vczjk/oe3;Llyiahf/vczjk/oe3;)V
...
.method private static final hookLocalService$lambda$6$lambda$0(Ljava/lang/String;)Llyiahf/vczjk/z8a;
    .locals 1
...
.method private static final hookLocalService$lambda$6$lambda$5(Lde/robv/android/xposed/XC_MethodHook$MethodHookParam;)Llyiahf/vczjk/z8a;
    .locals 10
    ...
    invoke-static {v7, v3}, Llyiahf/vczjk/d21;->OoooooO(Ljava/lang/Iterable;Ljava/lang/Object;)Z
...
.method private static final hookStartShortcut$lambda$17$lambda$15(Ljava/lang/String;)Llyiahf/vczjk/z8a;
    .locals 1
...
.method private static final hookStartShortcut$lambda$17$lambda$16(Lde/robv/android/xposed/XC_MethodHook$MethodHookParam;)Llyiahf/vczjk/z8a;
    .locals 5
    ...
    iget-object v1, v1, Llyiahf/vczjk/a;->Oooooo:Ljava/util/HashMap;
