.class public Lgithub/tornaco/android/thanos/services/xposed/hooks/task/CreateRecentTaskInfoRegistryP;
...
.method private hookIsVisibleRecentTask(Lgithub/tornaco/android/thanos/services/xposed/ISystemServerLoaded$Param;)V
    .locals 3

    :try_start_0
    invoke-virtual {p0, p1}, Lgithub/tornaco/android/thanos/services/xposed/hooks/task/CreateRecentTaskInfoRegistryP;->clazzToHook(Lgithub/tornaco/android/thanos/services/xposed/ISystemServerLoaded$Param;)Ljava/lang/Class;

    move-result-object p1

    invoke-static {p1}, Ljava/lang/String;->valueOf(Ljava/lang/Object;)Ljava/lang/String;

    invoke-virtual {p0}, Lgithub/tornaco/android/thanos/services/xposed/hooks/task/CreateRecentTaskInfoRegistryP;->methodToHook()Ljava/lang/String;

    move-result-object v0

    new-instance v1, Lgithub/tornaco/android/thanos/services/xposed/hooks/task/CreateRecentTaskInfoRegistryP$1;

    invoke-direct {v1, p0}, Lgithub/tornaco/android/thanos/services/xposed/hooks/task/CreateRecentTaskInfoRegistryP$1;-><init>(Lgithub/tornaco/android/thanos/services/xposed/hooks/task/CreateRecentTaskInfoRegistryP;)V
    ...
    const-string v2, "Fail hookIsVisibleRecentTask: "
    ...
    const-string v0, "hookIsVisibleRecentTask"
...
.method public clazzToHook(Lgithub/tornaco/android/thanos/services/xposed/ISystemServerLoaded$Param;)Ljava/lang/Class;
    ...
    const-string v0, "com.android.server.am.RecentTasks"
...
.method public methodToHook()Ljava/lang/String;
    ...
    const-string v0, "isVisibleRecentTask"
...
.method public onSystemServerLoaded(Lgithub/tornaco/android/thanos/services/xposed/ISystemServerLoaded$Param;)V
    ...
    invoke-direct {p0, p1}, Lgithub/tornaco/android/thanos/services/xposed/hooks/task/CreateRecentTaskInfoRegistryP;->hookIsVisibleRecentTask(Lgithub/tornaco/android/thanos/services/xposed/ISystemServerLoaded$Param;)V
