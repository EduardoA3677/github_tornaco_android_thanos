...
.field public Oooo0oO:Llyiahf/vczjk/sn5;

.field public Oooo0oo:Lgithub/tornaco/android/thanos/core/profile/RuleInfo;

.field public OoooO:Llyiahf/vczjk/era;

.field public OoooO0:Z

.field public OoooO00:I

.field public OoooO0O:Llyiahf/vczjk/zu1;
...
.method public static OooOoo(Landroid/content/Context;Lgithub/tornaco/android/thanos/core/profile/RuleInfo;IZ)V
    ...
    invoke-static {p0, p1, v0}, Llyiahf/vczjk/bua;->OoooO00(Landroid/content/Context;Ljava/lang/Class;Landroid/os/Bundle;)V
...
.method public final OooOoOO()Ljava/lang/String;
    ...
    iget-object v0, p0, Lgithub/tornaco/thanos/android/module/profile/RuleEditorActivity;->Oooo0oO:Llyiahf/vczjk/sn5;

    iget-object v0, v0, Llyiahf/vczjk/sn5;->OooOOO:Lcom/amrdeveloper/codeview/CodeView;
...
.method public final OooOoo0()V
    ...
    iget-object v1, v0, Llyiahf/vczjk/w3;->OooOOO:Ljava/lang/Object;
    ...
    new-instance v1, Llyiahf/vczjk/ww7;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Llyiahf/vczjk/ww7;-><init>(Lgithub/tornaco/thanos/android/module/profile/RuleEditorActivity;I)V

    const v2, 0x104000a

    invoke-virtual {v0, v2, v1}, Llyiahf/vczjk/kd5;->OooOo00(ILandroid/content/DialogInterface$OnClickListener;)V
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    sget v3, Llyiahf/vczjk/sn5;->OooOo0O:I
    ...
    check-cast p1, Llyiahf/vczjk/sn5;

    iput-object p1, p0, Lgithub/tornaco/thanos/android/module/profile/RuleEditorActivity;->Oooo0oO:Llyiahf/vczjk/sn5;
    ...
    iget-object p1, p0, Lgithub/tornaco/thanos/android/module/profile/RuleEditorActivity;->Oooo0oO:Llyiahf/vczjk/sn5;

    iget-object p1, p1, Llyiahf/vczjk/sn5;->OooOo00:Landroidx/appcompat/widget/Toolbar;
    ...
    new-instance v4, Llyiahf/vczjk/zw7;

    invoke-direct {v4, p0}, Llyiahf/vczjk/zw7;-><init>(Lgithub/tornaco/thanos/android/module/profile/RuleEditorActivity;)V
    ...
    iget-object p1, p1, Llyiahf/vczjk/sn5;->OooOOO:Lcom/amrdeveloper/codeview/CodeView;
    ...
    :goto_3
    iget-object v3, p0, Lgithub/tornaco/thanos/android/module/profile/RuleEditorActivity;->Oooo0oO:Llyiahf/vczjk/sn5;

    iget-object v3, v3, Llyiahf/vczjk/sn5;->OooOOOo:Landroidx/appcompat/widget/Toolbar;

    invoke-virtual {v3, p1}, Landroid/view/View;->setVisibility(I)V

    iget-object v3, p0, Lgithub/tornaco/thanos/android/module/profile/RuleEditorActivity;->Oooo0oO:Llyiahf/vczjk/sn5;

    iget-object v3, v3, Llyiahf/vczjk/sn5;->OooOOo0:Landroidx/appcompat/widget/Toolbar;

    invoke-virtual {v3, p1}, Landroid/view/View;->setVisibility(I)V

    iget-object v3, p0, Lgithub/tornaco/thanos/android/module/profile/RuleEditorActivity;->Oooo0oO:Llyiahf/vczjk/sn5;

    iget-object v3, v3, Llyiahf/vczjk/sn5;->OooOOo:Landroidx/appcompat/widget/Toolbar;
    ...
    new-instance v3, Llyiahf/vczjk/ri3;

    invoke-direct {v3, p0, v0}, Llyiahf/vczjk/ri3;-><init>(Lgithub/tornaco/android/thanos/theme/ThemeActivity;I)V
    ...
    iget-object v4, p0, Lgithub/tornaco/thanos/android/module/profile/RuleEditorActivity;->Oooo0oO:Llyiahf/vczjk/sn5;

    iget-object v4, v4, Llyiahf/vczjk/sn5;->OooOOOo:Landroidx/appcompat/widget/Toolbar;
    ...
    iget-object v4, v4, Llyiahf/vczjk/sn5;->OooOOo0:Landroidx/appcompat/widget/Toolbar;
    ...
    iget-object v4, v4, Llyiahf/vczjk/sn5;->OooOOo:Landroidx/appcompat/widget/Toolbar;
    ...
    :cond_9
    new-instance p1, Llyiahf/vczjk/xw7;

    invoke-direct {p1, p0, v1}, Llyiahf/vczjk/xw7;-><init>(Lgithub/tornaco/thanos/android/module/profile/RuleEditorActivity;I)V

    iget-object v0, p0, Lgithub/tornaco/thanos/android/module/profile/RuleEditorActivity;->Oooo0oO:Llyiahf/vczjk/sn5;

    iget-object v0, v0, Llyiahf/vczjk/sn5;->OooOOOo:Landroidx/appcompat/widget/Toolbar;

    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/Toolbar;->setOnMenuItemClickListener(Llyiahf/vczjk/vw9;)V

    iget-object v0, p0, Lgithub/tornaco/thanos/android/module/profile/RuleEditorActivity;->Oooo0oO:Llyiahf/vczjk/sn5;

    iget-object v0, v0, Llyiahf/vczjk/sn5;->OooOOo0:Landroidx/appcompat/widget/Toolbar;

    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/Toolbar;->setOnMenuItemClickListener(Llyiahf/vczjk/vw9;)V

    iget-object v0, p0, Lgithub/tornaco/thanos/android/module/profile/RuleEditorActivity;->Oooo0oO:Llyiahf/vczjk/sn5;

    iget-object v0, v0, Llyiahf/vczjk/sn5;->OooOOo:Landroidx/appcompat/widget/Toolbar;

    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/Toolbar;->setOnMenuItemClickListener(Llyiahf/vczjk/vw9;)V

    iget-object p1, p0, Lgithub/tornaco/thanos/android/module/profile/RuleEditorActivity;->Oooo0oO:Llyiahf/vczjk/sn5;

    iget-object p1, p1, Llyiahf/vczjk/sn5;->OooOOOO:Landroidx/appcompat/widget/Toolbar;
    ...
    new-instance v0, Llyiahf/vczjk/xw7;

    invoke-direct {v0, p0, v2}, Llyiahf/vczjk/xw7;-><init>(Lgithub/tornaco/thanos/android/module/profile/RuleEditorActivity;I)V

    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/Toolbar;->setOnMenuItemClickListener(Llyiahf/vczjk/vw9;)V
    ...
    invoke-virtual {p1, v0}, Llyiahf/vczjk/sn5;->OooO0o0(Ljava/lang/String;)V
    ...
    invoke-static {p0}, Llyiahf/vczjk/c6a;->Oooooo0(Landroid/content/Context;)Landroid/graphics/Typeface;
    ...
    invoke-direct {v0, p0, p1}, Llyiahf/vczjk/era;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    iput-object v0, p0, Lgithub/tornaco/thanos/android/module/profile/RuleEditorActivity;->OoooO:Llyiahf/vczjk/era;

    invoke-virtual {v0}, Llyiahf/vczjk/era;->OooOo0()V
    ...
    invoke-direct {v0, p1}, Llyiahf/vczjk/zu1;-><init>(Landroid/widget/TextView;)V

    iput-object v0, p0, Lgithub/tornaco/thanos/android/module/profile/RuleEditorActivity;->OoooO0O:Llyiahf/vczjk/zu1;

    iget-object v0, v0, Llyiahf/vczjk/zu1;->OooO0Oo:Ljava/lang/Object;

    check-cast v0, Llyiahf/vczjk/n8a;
    ...
    iget-object v0, p0, Lgithub/tornaco/thanos/android/module/profile/RuleEditorActivity;->OoooO:Llyiahf/vczjk/era;
    ...
    :cond_d
    sget-object v1, Llyiahf/vczjk/ha4;->OooO00o:Ljava/util/regex/Pattern;
    ...
    iget-object p1, p1, Llyiahf/vczjk/sn5;->OooOOO0:Lcom/google/android/material/button/MaterialButton;
...
.method public final onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    iget-object v0, p0, Lgithub/tornaco/thanos/android/module/profile/RuleEditorActivity;->OoooO0O:Llyiahf/vczjk/zu1;

    iget-object v1, v0, Llyiahf/vczjk/zu1;->OooO0OO:Ljava/lang/Object;

    check-cast v1, Llyiahf/vczjk/w3;

    iget v6, v1, Llyiahf/vczjk/w3;->OooOOO0:I
    ...
    iput v6, v1, Llyiahf/vczjk/w3;->OooOOO0:I
    ...
    check-cast v1, Llyiahf/vczjk/m8a;
    ...
    :cond_2
    iget-object v6, v0, Llyiahf/vczjk/zu1;->OooO0O0:Ljava/lang/Object;
    ...
    iget v7, v1, Llyiahf/vczjk/m8a;->OooO00o:I

    iget-object v8, v1, Llyiahf/vczjk/m8a;->OooO0OO:Ljava/lang/CharSequence;
    ...
    iput-boolean v3, v0, Llyiahf/vczjk/zu1;->OooO00o:Z

    iget-object v9, v1, Llyiahf/vczjk/m8a;->OooO0O0:Ljava/lang/CharSequence;

    invoke-interface {v6, v7, v8, v9}, Landroid/text/Editable;->replace(IILjava/lang/CharSequence;)Landroid/text/Editable;

    iput-boolean v5, v0, Llyiahf/vczjk/zu1;->OooO00o:Z
    ...
    :cond_4
    iget-object v0, v1, Llyiahf/vczjk/m8a;->OooO0O0:Ljava/lang/CharSequence;
    ...
    iget-object v7, v1, Llyiahf/vczjk/w3;->OooOOO:Ljava/lang/Object;
    ...
    :cond_8
    iget-object v1, v0, Llyiahf/vczjk/zu1;->OooO0O0:Ljava/lang/Object;
    ...
    iget v6, v2, Llyiahf/vczjk/m8a;->OooO00o:I

    iget-object v7, v2, Llyiahf/vczjk/m8a;->OooO0O0:Ljava/lang/CharSequence;
    ...
    iget-object v3, v2, Llyiahf/vczjk/m8a;->OooO0OO:Ljava/lang/CharSequence;
    ...
    :cond_a
    iget-object v0, v2, Llyiahf/vczjk/m8a;->OooO0OO:Ljava/lang/CharSequence;
