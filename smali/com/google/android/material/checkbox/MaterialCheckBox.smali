...
.field public final Oooo0:Llyiahf/vczjk/jk;
...
.field public final Oooo0O0:Llyiahf/vczjk/p80;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    new-instance v1, Llyiahf/vczjk/jk;

    invoke-direct {v1, p1}, Llyiahf/vczjk/jk;-><init>(Landroid/content/Context;)V
    ...
    iput-object p1, v1, Llyiahf/vczjk/hda;->OooOOO0:Landroid/graphics/drawable/Drawable;

    iget-object v0, v1, Llyiahf/vczjk/jk;->OooOOo:Llyiahf/vczjk/gk;

    invoke-virtual {p1, v0}, Landroid/graphics/drawable/Drawable;->setCallback(Landroid/graphics/drawable/Drawable$Callback;)V

    new-instance p1, Llyiahf/vczjk/ik;

    iget-object v0, v1, Llyiahf/vczjk/hda;->OooOOO0:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v0}, Landroid/graphics/drawable/Drawable;->getConstantState()Landroid/graphics/drawable/Drawable$ConstantState;

    move-result-object v0

    invoke-direct {p1, v0}, Llyiahf/vczjk/ik;-><init>(Landroid/graphics/drawable/Drawable$ConstantState;)V

    iput-object v1, p0, Lcom/google/android/material/checkbox/MaterialCheckBox;->Oooo0:Llyiahf/vczjk/jk;

    new-instance p1, Llyiahf/vczjk/p80;

    const/4 v0, 0x2

    invoke-direct {p1, p0, v0}, Llyiahf/vczjk/p80;-><init>(Landroid/view/View;I)V

    iput-object p1, p0, Lcom/google/android/material/checkbox/MaterialCheckBox;->Oooo0O0:Llyiahf/vczjk/p80;
    ...
    invoke-interface {p0, p1}, Llyiahf/vczjk/ms9;->setSupportButtonTintList(Landroid/content/res/ColorStateList;)V
    ...
    invoke-static/range {v0 .. v5}, Llyiahf/vczjk/lq9;->OooO0o0(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Llyiahf/vczjk/ed5;
    ...
    invoke-static {v0, p2, p1}, Llyiahf/vczjk/cp7;->OooOo0(Landroid/content/Context;Llyiahf/vczjk/ed5;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, p3}, Llyiahf/vczjk/ls6;->OooOOOO(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
...
.method private getMaterialThemeColorsTintList()Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0, v0}, Llyiahf/vczjk/e16;->Oooo00o(Landroid/view/View;I)Landroid/util/TypedValue;

    move-result-object v0

    invoke-static {v1, v0}, Llyiahf/vczjk/vc6;->Oooo0oO(Landroid/content/Context;Landroid/util/TypedValue;)I
    ...
    invoke-static {p0, v1}, Llyiahf/vczjk/e16;->Oooo00o(Landroid/view/View;I)Landroid/util/TypedValue;

    move-result-object v1

    invoke-static {v2, v1}, Llyiahf/vczjk/vc6;->Oooo0oO(Landroid/content/Context;Landroid/util/TypedValue;)I
    ...
    invoke-static {p0, v2}, Llyiahf/vczjk/e16;->Oooo00o(Landroid/view/View;I)Landroid/util/TypedValue;
    ...
    invoke-static {p0, v3}, Llyiahf/vczjk/e16;->Oooo00o(Landroid/view/View;I)Landroid/util/TypedValue;

    move-result-object v3

    invoke-static {v4, v3}, Llyiahf/vczjk/vc6;->Oooo0oO(Landroid/content/Context;Landroid/util/TypedValue;)I

    move-result v3

    const/high16 v4, 0x3f800000    # 1.0f

    invoke-static {v2, v4, v1}, Llyiahf/vczjk/vc6;->Oooo00O(IFI)I

    move-result v1

    invoke-static {v2, v4, v0}, Llyiahf/vczjk/vc6;->Oooo00O(IFI)I

    move-result v0

    const v4, 0x3f0a3d71    # 0.54f

    invoke-static {v2, v4, v3}, Llyiahf/vczjk/vc6;->Oooo00O(IFI)I

    move-result v4

    const v5, 0x3ec28f5c    # 0.38f

    invoke-static {v2, v5, v3}, Llyiahf/vczjk/vc6;->Oooo00O(IFI)I
...
.method private getSuperButtonTintList()Landroid/content/res/ColorStateList;
    ...
    :cond_1
    invoke-interface {p0}, Llyiahf/vczjk/ms9;->getSupportButtonTintList()Landroid/content/res/ColorStateList;
...
.method public final OooO00o()V
    ...
    invoke-static {v0, v1, v2}, Llyiahf/vczjk/dn8;->o000oOoO(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/material/checkbox/MaterialCheckBox;->Oooo0:Llyiahf/vczjk/jk;

    if-eqz v0, :cond_b

    iget-object v1, v0, Llyiahf/vczjk/hda;->OooOOO0:Landroid/graphics/drawable/Drawable;

    iget-object v2, p0, Lcom/google/android/material/checkbox/MaterialCheckBox;->Oooo0O0:Llyiahf/vczjk/p80;

    if-eqz v1, :cond_2

    check-cast v1, Landroid/graphics/drawable/AnimatedVectorDrawable;

    iget-object v3, v2, Llyiahf/vczjk/fi;->OooO00o:Llyiahf/vczjk/ei;

    if-nez v3, :cond_1

    new-instance v3, Llyiahf/vczjk/ei;

    invoke-direct {v3, v2}, Llyiahf/vczjk/ei;-><init>(Llyiahf/vczjk/fi;)V

    iput-object v3, v2, Llyiahf/vczjk/fi;->OooO00o:Llyiahf/vczjk/ei;
    ...
    iget-object v3, v0, Llyiahf/vczjk/jk;->OooOOO:Llyiahf/vczjk/hk;
    ...
    iget-object v1, v0, Llyiahf/vczjk/jk;->OooOOOo:Llyiahf/vczjk/o;

    if-eqz v1, :cond_4

    iget-object v4, v3, Llyiahf/vczjk/hk;->OooO0O0:Landroid/animation/AnimatorSet;

    invoke-virtual {v4, v1}, Landroid/animation/Animator;->removeListener(Landroid/animation/Animator$AnimatorListener;)V

    const/4 v1, 0x0

    iput-object v1, v0, Llyiahf/vczjk/jk;->OooOOOo:Llyiahf/vczjk/o;
    ...
    :cond_5
    iget-object v2, v2, Llyiahf/vczjk/fi;->OooO00o:Llyiahf/vczjk/ei;
    ...
    iput-object v1, v0, Llyiahf/vczjk/jk;->OooOOo0:Ljava/util/ArrayList;
    ...
    :cond_a
    iget-object v1, v3, Llyiahf/vczjk/hk;->OooO0O0:Landroid/animation/AnimatorSet;

    iget-object v2, v0, Llyiahf/vczjk/jk;->OooOOOo:Llyiahf/vczjk/o;
    ...
    invoke-static {v0, v1, v2, v2}, Llyiahf/vczjk/dn8;->Oooo0(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;II)Landroid/graphics/drawable/Drawable;
...
.method public final onCreateDrawableState(I)[I
    ...
    :cond_1
    invoke-static {p1}, Llyiahf/vczjk/dn8;->OoooOoo([I)[I
...
.method public setButtonTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-interface {p0, p1}, Llyiahf/vczjk/ms9;->setSupportButtonTintMode(Landroid/graphics/PorterDuff$Mode;)V
...
.method public setCheckedState(I)V
    ...
    :cond_3
    invoke-static {v1}, Llyiahf/vczjk/q99;->OooO0o0(Ljava/util/Iterator;)Ljava/lang/ClassCastException;
