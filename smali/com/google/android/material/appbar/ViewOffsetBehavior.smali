...
.field public OooOOO0:Llyiahf/vczjk/mha;
...
.method public OooOO0o(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)Z
    ...
    iget-object p1, p0, Lcom/google/android/material/appbar/ViewOffsetBehavior;->OooOOO0:Llyiahf/vczjk/mha;

    if-nez p1, :cond_0

    new-instance p1, Llyiahf/vczjk/mha;

    invoke-direct {p1, p2}, Llyiahf/vczjk/mha;-><init>(Landroid/view/View;)V

    iput-object p1, p0, Lcom/google/android/material/appbar/ViewOffsetBehavior;->OooOOO0:Llyiahf/vczjk/mha;

    :cond_0
    iget-object p1, p0, Lcom/google/android/material/appbar/ViewOffsetBehavior;->OooOOO0:Llyiahf/vczjk/mha;

    iget-object p2, p1, Llyiahf/vczjk/mha;->OooO00o:Landroid/view/View;

    invoke-virtual {p2}, Landroid/view/View;->getTop()I

    move-result p3

    iput p3, p1, Llyiahf/vczjk/mha;->OooO0O0:I

    invoke-virtual {p2}, Landroid/view/View;->getLeft()I

    move-result p2

    iput p2, p1, Llyiahf/vczjk/mha;->OooO0OO:I

    iget-object p1, p0, Lcom/google/android/material/appbar/ViewOffsetBehavior;->OooOOO0:Llyiahf/vczjk/mha;

    invoke-virtual {p1}, Llyiahf/vczjk/mha;->OooO00o()V

    iget p1, p0, Lcom/google/android/material/appbar/ViewOffsetBehavior;->OooOOO:I

    if-eqz p1, :cond_1

    iget-object p2, p0, Lcom/google/android/material/appbar/ViewOffsetBehavior;->OooOOO0:Llyiahf/vczjk/mha;

    invoke-virtual {p2, p1}, Llyiahf/vczjk/mha;->OooO0O0(I)Z
...
.method public OooOo0o()I
    ...
    iget-object v0, p0, Lcom/google/android/material/appbar/ViewOffsetBehavior;->OooOOO0:Llyiahf/vczjk/mha;

    if-eqz v0, :cond_0

    iget v0, v0, Llyiahf/vczjk/mha;->OooO0Oo:I
...
.method public OooOoO(I)Z
    ...
    invoke-virtual {v0, p1}, Llyiahf/vczjk/mha;->OooO0O0(I)Z
