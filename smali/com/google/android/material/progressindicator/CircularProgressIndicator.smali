...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    new-instance p1, Llyiahf/vczjk/yw0;

    iget-object p2, p0, Lcom/google/android/material/progressindicator/OooO00o;->OooOOO0:Llyiahf/vczjk/q80;

    check-cast p2, Lcom/google/android/material/progressindicator/CircularProgressIndicatorSpec;

    invoke-direct {p1, p2}, Llyiahf/vczjk/yw0;-><init>(Lcom/google/android/material/progressindicator/CircularProgressIndicatorSpec;)V

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object p3

    new-instance v0, Llyiahf/vczjk/dx3;
    ...
    new-instance v1, Llyiahf/vczjk/cx0;

    invoke-direct {v1, p3, p2}, Llyiahf/vczjk/cx0;-><init>(Landroid/content/Context;Lcom/google/android/material/progressindicator/CircularProgressIndicatorSpec;)V

    goto :goto_0

    :cond_0
    new-instance v1, Llyiahf/vczjk/ax0;

    invoke-direct {v1, p2}, Llyiahf/vczjk/ax0;-><init>(Lcom/google/android/material/progressindicator/CircularProgressIndicatorSpec;)V

    :goto_0
    invoke-direct {v0, p3, p2, p1, v1}, Llyiahf/vczjk/dx3;-><init>(Landroid/content/Context;Llyiahf/vczjk/q80;Llyiahf/vczjk/ri2;Llyiahf/vczjk/o0O00o00;)V
    ...
    new-instance v2, Llyiahf/vczjk/qda;

    invoke-direct {v2}, Llyiahf/vczjk/qda;-><init>()V
    ...
    iput-object p3, v2, Llyiahf/vczjk/hda;->OooOOO0:Landroid/graphics/drawable/Drawable;

    new-instance p3, Llyiahf/vczjk/pda;

    iget-object v1, v2, Llyiahf/vczjk/hda;->OooOOO0:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v1}, Landroid/graphics/drawable/Drawable;->getConstantState()Landroid/graphics/drawable/Drawable$ConstantState;

    move-result-object v1

    invoke-direct {p3, v1}, Llyiahf/vczjk/pda;-><init>(Landroid/graphics/drawable/Drawable$ConstantState;)V

    iput-object v2, v0, Llyiahf/vczjk/dx3;->OooOoo0:Llyiahf/vczjk/qda;
    ...
    new-instance v0, Llyiahf/vczjk/k92;

    invoke-direct {v0, p3, p2, p1}, Llyiahf/vczjk/k92;-><init>(Landroid/content/Context;Llyiahf/vczjk/q80;Llyiahf/vczjk/ri2;)V
...
# virtual methods
.method public final OooO00o(Landroid/content/Context;Landroid/util/AttributeSet;)Llyiahf/vczjk/q80;
    .locals 1
...
.method public setIndeterminateAnimationType(I)V
    ...
    invoke-virtual {v1}, Llyiahf/vczjk/q80;->OooO0Oo()V

    const/4 v1, 0x1

    if-ne p1, v1, :cond_3

    new-instance p1, Llyiahf/vczjk/cx0;
    ...
    invoke-direct {p1, v1, v0}, Llyiahf/vczjk/cx0;-><init>(Landroid/content/Context;Lcom/google/android/material/progressindicator/CircularProgressIndicatorSpec;)V

    goto :goto_1

    :cond_3
    new-instance p1, Llyiahf/vczjk/ax0;

    check-cast v0, Lcom/google/android/material/progressindicator/CircularProgressIndicatorSpec;

    invoke-direct {p1, v0}, Llyiahf/vczjk/ax0;-><init>(Lcom/google/android/material/progressindicator/CircularProgressIndicatorSpec;)V
    ...
    iput-object p1, v0, Llyiahf/vczjk/dx3;->OooOoOO:Llyiahf/vczjk/o0O00o00;

    iput-object v0, p1, Llyiahf/vczjk/o0O00o00;->OooO00o:Ljava/lang/Object;
...
.method public setTrackThickness(I)V
    ...
    iget-object p1, p0, Lcom/google/android/material/progressindicator/OooO00o;->OooOOO0:Llyiahf/vczjk/q80;

    check-cast p1, Lcom/google/android/material/progressindicator/CircularProgressIndicatorSpec;

    invoke-virtual {p1}, Llyiahf/vczjk/q80;->OooO0Oo()V
