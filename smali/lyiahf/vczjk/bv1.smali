.class public final Llyiahf/vczjk/bv1;
...
.method public constructor <init>(Landroidx/browser/customtabs/CustomTabsService;)V
    ...
    iput-object p1, p0, Llyiahf/vczjk/bv1;->OooO0o0:Landroidx/browser/customtabs/CustomTabsService;
...
.method public final OooO0oO(Landroid/support/customtabs/ICustomTabsCallback;Landroid/app/PendingIntent;)Z
    ...
    new-instance v0, Llyiahf/vczjk/cv1;

    invoke-direct {v0, p1, p2}, Llyiahf/vczjk/cv1;-><init>(Landroid/support/customtabs/ICustomTabsCallback;Landroid/app/PendingIntent;)V

    const/4 p2, 0x0

    :try_start_0
    new-instance v1, Llyiahf/vczjk/av1;

    invoke-direct {v1, p0, v0}, Llyiahf/vczjk/av1;-><init>(Llyiahf/vczjk/bv1;Llyiahf/vczjk/cv1;)V

    iget-object v0, p0, Llyiahf/vczjk/bv1;->OooO0o0:Landroidx/browser/customtabs/CustomTabsService;

    iget-object v0, v0, Landroidx/browser/customtabs/CustomTabsService;->OooOOO0:Llyiahf/vczjk/ao8;
    ...
    iget-object v2, p0, Llyiahf/vczjk/bv1;->OooO0o0:Landroidx/browser/customtabs/CustomTabsService;

    iget-object v2, v2, Landroidx/browser/customtabs/CustomTabsService;->OooOOO0:Llyiahf/vczjk/ao8;

    invoke-interface {p1}, Landroid/os/IInterface;->asBinder()Landroid/os/IBinder;

    move-result-object p1

    invoke-virtual {v2, p1, v1}, Llyiahf/vczjk/ao8;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :try_start_2
    iget-object p1, p0, Llyiahf/vczjk/bv1;->OooO0o0:Landroidx/browser/customtabs/CustomTabsService;
...
.method public final isEngagementSignalsApiAvailable(Landroid/support/customtabs/ICustomTabsCallback;Landroid/os/Bundle;)Z
    ...
    invoke-static {p2}, Llyiahf/vczjk/bv1;->OooO0o(Landroid/os/Bundle;)Landroid/app/PendingIntent;
...
.method public final mayLaunchUrl(Landroid/support/customtabs/ICustomTabsCallback;Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
    ...
    invoke-static {p3}, Llyiahf/vczjk/bv1;->OooO0o(Landroid/os/Bundle;)Landroid/app/PendingIntent;
...
.method public final newSession(Landroid/support/customtabs/ICustomTabsCallback;)Z
    ...
    invoke-virtual {p0, p1, v0}, Llyiahf/vczjk/bv1;->OooO0oO(Landroid/support/customtabs/ICustomTabsCallback;Landroid/app/PendingIntent;)Z
...
.method public final newSessionWithExtras(Landroid/support/customtabs/ICustomTabsCallback;Landroid/os/Bundle;)Z
    ...
    invoke-virtual {p0, p1, p2}, Llyiahf/vczjk/bv1;->OooO0oO(Landroid/support/customtabs/ICustomTabsCallback;Landroid/app/PendingIntent;)Z
...
.method public final receiveFile(Landroid/support/customtabs/ICustomTabsCallback;Landroid/net/Uri;ILandroid/os/Bundle;)Z
    ...
    invoke-static {p4}, Llyiahf/vczjk/bv1;->OooO0o(Landroid/os/Bundle;)Landroid/app/PendingIntent;
...
.method public final requestPostMessageChannelWithExtras(Landroid/support/customtabs/ICustomTabsCallback;Landroid/net/Uri;Landroid/os/Bundle;)Z
    ...
    invoke-static {p3, v0, p1}, Llyiahf/vczjk/ap;->OooO00o(Landroid/os/Bundle;Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;
