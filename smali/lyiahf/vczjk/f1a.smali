.class public final Llyiahf/vczjk/f1a;
...
.method public constructor <init>(Landroidx/browser/trusted/TrustedWebActivityService;)V
    ...
    iput-object p1, p0, Llyiahf/vczjk/f1a;->OooO0o0:Landroidx/browser/trusted/TrustedWebActivityService;
...
.method public final OooO0o()V
    ...
    iget-object v0, p0, Llyiahf/vczjk/f1a;->OooO0o0:Landroidx/browser/trusted/TrustedWebActivityService;
    ...
    invoke-virtual {v0}, Landroidx/browser/trusted/TrustedWebActivityService;->OooO0O0()Llyiahf/vczjk/zt9;
...
.method public final areNotificationsEnabled(Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    invoke-virtual {p0}, Llyiahf/vczjk/f1a;->OooO0o()V

    const-string v0, "android.support.customtabs.trusted.CHANNEL_NAME"

    invoke-static {p1, v0}, Llyiahf/vczjk/vo6;->OooO0OO(Landroid/os/Bundle;Ljava/lang/String;)V
    ...
    invoke-direct {v1, v0}, Llyiahf/vczjk/e36;-><init>(Landroid/content/Context;)V
    ...
    invoke-static {v0, p1}, Llyiahf/vczjk/c84;->OooOO0(Landroid/app/NotificationManager;Ljava/lang/String;)Landroid/app/NotificationChannel;

    move-result-object p1

    if-eqz p1, :cond_1

    invoke-static {p1}, Llyiahf/vczjk/c84;->OooO0O0(Landroid/app/NotificationChannel;)I
...
.method public final cancelNotification(Landroid/os/Bundle;)V
    ...
    invoke-static {p1, v1}, Llyiahf/vczjk/vo6;->OooO0OO(Landroid/os/Bundle;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Llyiahf/vczjk/f1a;->OooO0o0:Landroidx/browser/trusted/TrustedWebActivityService;
...
.method public final extraCommand(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/IBinder;)Landroid/os/Bundle;
    ...
    :goto_0
    iget-object p1, p0, Llyiahf/vczjk/f1a;->OooO0o0:Landroidx/browser/trusted/TrustedWebActivityService;
...
.method public final notifyNotificationWithChannel(Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    invoke-static {p1, v2}, Llyiahf/vczjk/vo6;->OooO0OO(Landroid/os/Bundle;Ljava/lang/String;)V

    const-string v3, "android.support.customtabs.trusted.CHANNEL_NAME"

    invoke-static {p1, v3}, Llyiahf/vczjk/vo6;->OooO0OO(Landroid/os/Bundle;Ljava/lang/String;)V
    ...
    iget-object v3, p0, Llyiahf/vczjk/f1a;->OooO0o0:Landroidx/browser/trusted/TrustedWebActivityService;

    iget-object v4, v3, Landroidx/browser/trusted/TrustedWebActivityService;->OooOOO0:Landroid/app/NotificationManager;

    if-eqz v4, :cond_4

    new-instance v4, Llyiahf/vczjk/e36;

    invoke-direct {v4, v3}, Llyiahf/vczjk/e36;-><init>(Landroid/content/Context;)V

    iget-object v4, v4, Llyiahf/vczjk/e36;->OooO00o:Landroid/app/NotificationManager;
    ...
    invoke-static {v4, p1}, Llyiahf/vczjk/c84;->OooOO0o(Ljava/lang/String;Ljava/lang/String;)Landroid/app/NotificationChannel;

    move-result-object p1

    invoke-static {v6, p1}, Llyiahf/vczjk/c84;->OooOo0(Landroid/app/NotificationManager;Landroid/app/NotificationChannel;)V

    invoke-static {v6, v4}, Llyiahf/vczjk/c84;->OooOO0(Landroid/app/NotificationManager;Ljava/lang/String;)Landroid/app/NotificationChannel;
    ...
    invoke-static {p1, v4}, Llyiahf/vczjk/c84;->OooOOo(Landroid/app/Notification$Builder;Ljava/lang/String;)V
    ...
    invoke-static {p1, v4}, Llyiahf/vczjk/c84;->OooOO0(Landroid/app/NotificationManager;Ljava/lang/String;)Landroid/app/NotificationChannel;
