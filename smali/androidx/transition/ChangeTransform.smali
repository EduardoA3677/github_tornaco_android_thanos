...
.field public static final OoooOOo:Llyiahf/vczjk/cs0;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/transition/ChangeTransform;->OoooOOo:Llyiahf/vczjk/cs0;
    ...
    sput-object v0, Landroidx/transition/ChangeTransform;->OoooOo0:Llyiahf/vczjk/cs0;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v1, Llyiahf/vczjk/ye5;->OooOOoo:[I
    ...
    invoke-static {p2, v1}, Llyiahf/vczjk/ru6;->OooOo0o(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
...
.method public final OooO0Oo(Llyiahf/vczjk/xz9;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/transition/ChangeTransform;->OoooO0(Llyiahf/vczjk/xz9;)V
...
.method public final OooOO0o(Landroid/view/ViewGroup;Llyiahf/vczjk/xz9;Llyiahf/vczjk/xz9;)Landroid/animation/Animator;
    ...
    iget-object v7, v0, Llyiahf/vczjk/xz9;->OooO00o:Ljava/util/HashMap;
    ...
    iget-object v9, v3, Llyiahf/vczjk/xz9;->OooO00o:Ljava/util/HashMap;
    ...
    invoke-virtual {v1, v10}, Landroidx/transition/Transition;->OooOoO(Landroid/view/View;)Z

    move-result v12

    if-eqz v12, :cond_3

    invoke-virtual {v1, v11}, Landroidx/transition/Transition;->OooOoO(Landroid/view/View;)Z
    ...
    :cond_2
    invoke-virtual {v1, v10, v5}, Landroidx/transition/Transition;->OooOOo(Landroid/view/View;Z)Llyiahf/vczjk/xz9;

    move-result-object v12

    if-eqz v12, :cond_4

    iget-object v12, v12, Llyiahf/vczjk/xz9;->OooO0O0:Landroid/view/View;
    ...
    :cond_7
    iget-object v14, v3, Llyiahf/vczjk/xz9;->OooO0O0:Landroid/view/View;
    ...
    sget-object v3, Llyiahf/vczjk/cf5;->OooO00o:Llyiahf/vczjk/bf5;

    :cond_a
    if-nez v11, :cond_b

    sget-object v11, Llyiahf/vczjk/cf5;->OooO00o:Llyiahf/vczjk/bf5;
    ...
    check-cast v12, Llyiahf/vczjk/ps0;

    invoke-virtual {v14, v6}, Landroid/view/View;->setTranslationX(F)V

    invoke-virtual {v14, v6}, Landroid/view/View;->setTranslationY(F)V

    sget-object v16, Llyiahf/vczjk/xfa;->OooO00o:Ljava/util/WeakHashMap;

    invoke-static {v14, v6}, Llyiahf/vczjk/ofa;->OooOOOO(Landroid/view/View;F)V
    ...
    new-instance v5, Llyiahf/vczjk/os0;

    invoke-direct {v5, v14, v6}, Llyiahf/vczjk/os0;-><init>(Landroid/view/View;[F)V

    new-instance v4, Llyiahf/vczjk/u23;
    ...
    invoke-direct {v4, v11}, Llyiahf/vczjk/u23;-><init>(I)V

    iput-object v15, v4, Llyiahf/vczjk/u23;->OooO0O0:Ljava/lang/Object;

    filled-new-array {v6, v3}, [[F

    move-result-object v11

    sget-object v15, Landroidx/transition/ChangeTransform;->OoooOOo:Llyiahf/vczjk/cs0;
    ...
    iget-object v11, v1, Landroidx/transition/Transition;->Oooo0o0:Llyiahf/vczjk/ly9;
    ...
    invoke-virtual {v11, v15, v6, v3, v12}, Llyiahf/vczjk/ly9;->OooO00o(FFFF)Landroid/graphics/Path;

    move-result-object v3

    sget-object v6, Landroidx/transition/ChangeTransform;->OoooOo0:Llyiahf/vczjk/cs0;

    invoke-static {v6, v3}, Llyiahf/vczjk/mb7;->OooO00o(Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/PropertyValuesHolder;
    ...
    new-instance v13, Llyiahf/vczjk/ns0;
    ...
    invoke-direct/range {v13 .. v19}, Llyiahf/vczjk/ns0;-><init>(Landroid/view/View;Llyiahf/vczjk/ps0;Llyiahf/vczjk/os0;Landroid/graphics/Matrix;ZZ)V
    ...
    :goto_3
    iget-object v6, v0, Llyiahf/vczjk/xz9;->OooO0O0:Landroid/view/View;
    ...
    invoke-virtual {v0, v2, v4}, Llyiahf/vczjk/jja;->Oooo00o(Landroid/view/View;Landroid/graphics/Matrix;)V
    ...
    sget-boolean v0, Llyiahf/vczjk/sw7;->OooOOo:Z

    if-nez v0, :cond_d

    :try_start_0
    invoke-static {}, Llyiahf/vczjk/sw7;->OooO0oo()V

    sget-object v0, Llyiahf/vczjk/sw7;->OooOOOO:Ljava/lang/Class;
    ...
    sput-object v0, Llyiahf/vczjk/sw7;->OooOOo0:Ljava/lang/reflect/Method;
    ...
    :goto_5
    sput-boolean v22, Llyiahf/vczjk/sw7;->OooOOo:Z

    :cond_d
    sget-object v0, Llyiahf/vczjk/sw7;->OooOOo0:Ljava/lang/reflect/Method;

    if-eqz v0, :cond_e

    :try_start_1
    new-instance v9, Llyiahf/vczjk/sw7;
    ...
    invoke-direct {v9, v0, v2}, Llyiahf/vczjk/sw7;-><init>(Ljava/lang/Object;I)V
    :try_end_1
    ...
    :cond_f
    sget v0, Llyiahf/vczjk/ih3;->OooOOoo:I
    ...
    sget v0, Llyiahf/vczjk/hh3;->OooOOOO:I
    ...
    check-cast v0, Llyiahf/vczjk/hh3;
    ...
    check-cast v9, Llyiahf/vczjk/ih3;
    ...
    check-cast v12, Llyiahf/vczjk/hh3;

    if-eq v12, v0, :cond_10

    iget v13, v9, Llyiahf/vczjk/ih3;->OooOOOo:I
    ...
    new-instance v9, Llyiahf/vczjk/ih3;

    invoke-direct {v9, v14}, Llyiahf/vczjk/ih3;-><init>(Landroid/view/View;)V

    iput-object v4, v9, Llyiahf/vczjk/ih3;->OooOOo0:Landroid/graphics/Matrix;

    if-nez v0, :cond_11

    new-instance v0, Llyiahf/vczjk/hh3;
    ...
    iput-object v2, v0, Llyiahf/vczjk/hh3;->OooOOO0:Landroid/view/ViewGroup;
    ...
    iput-boolean v4, v0, Llyiahf/vczjk/hh3;->OooOOO:Z

    goto :goto_8

    :cond_11
    iget-boolean v4, v0, Llyiahf/vczjk/hh3;->OooOOO:Z

    if-eqz v4, :cond_22

    iget-object v4, v0, Llyiahf/vczjk/hh3;->OooOOO0:Landroid/view/ViewGroup;
    ...
    invoke-static {v0, v4, v12, v15, v5}, Llyiahf/vczjk/dja;->OooO00o(Landroid/view/View;IIII)V
    ...
    invoke-static {v9, v4, v5, v15, v2}, Llyiahf/vczjk/dja;->OooO00o(Landroid/view/View;IIII)V

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    iget-object v4, v9, Llyiahf/vczjk/ih3;->OooOOOO:Landroid/view/View;

    invoke-static {v4, v2}, Llyiahf/vczjk/hh3;->OooO00o(Landroid/view/View;Ljava/util/ArrayList;)V
    ...
    check-cast v1, Llyiahf/vczjk/ih3;

    iget-object v1, v1, Llyiahf/vczjk/ih3;->OooOOOO:Landroid/view/View;

    invoke-static {v1, v4}, Llyiahf/vczjk/hh3;->OooO00o(Landroid/view/View;Ljava/util/ArrayList;)V
    ...
    invoke-static {v1}, Llyiahf/vczjk/gh3;->OooO00o(Landroid/view/View;)F

    move-result v18

    invoke-static {v2}, Llyiahf/vczjk/gh3;->OooO00o(Landroid/view/View;)F
    ...
    invoke-static {v3, v4}, Llyiahf/vczjk/pga;->OooO00o(Landroid/view/ViewGroup;I)I
    ...
    :cond_16
    sget-boolean v5, Llyiahf/vczjk/rd3;->OooO0o0:Z
    ...
    sput-object v5, Llyiahf/vczjk/rd3;->OooO0Oo:Ljava/lang/reflect/Method;
    :try_end_2
    ...
    :catch_4
    :goto_10
    sput-boolean v11, Llyiahf/vczjk/rd3;->OooO0o0:Z

    :cond_17
    sget-object v5, Llyiahf/vczjk/rd3;->OooO0Oo:Ljava/lang/reflect/Method;
    ...
    :goto_16
    iput v13, v9, Llyiahf/vczjk/ih3;->OooOOOo:I
    ...
    :goto_17
    iget v0, v9, Llyiahf/vczjk/ih3;->OooOOOo:I

    const/16 v22, 0x1

    add-int/lit8 v0, v0, 0x1

    iput v0, v9, Llyiahf/vczjk/ih3;->OooOOOo:I
    ...
    invoke-interface {v9, v0, v6}, Llyiahf/vczjk/fh3;->OooO0OO(Landroid/view/ViewGroup;Landroid/view/View;)V
    ...
    :cond_25
    new-instance v1, Llyiahf/vczjk/ms0;

    invoke-direct {v1}, Llyiahf/vczjk/ms0;-><init>()V

    iput-object v14, v1, Llyiahf/vczjk/ms0;->OooO0O0:Ljava/lang/Object;

    iput-object v9, v1, Llyiahf/vczjk/ms0;->OooO0OO:Ljava/lang/Object;

    invoke-virtual {v0, v1}, Landroidx/transition/Transition;->OooO00o(Llyiahf/vczjk/vy9;)V
    ...
    invoke-static {v6, v1}, Llyiahf/vczjk/dja;->OooO0O0(Landroid/view/View;F)V

    :cond_26
    const/high16 v5, 0x3f800000    # 1.0f

    invoke-static {v14, v5}, Llyiahf/vczjk/dja;->OooO0O0(Landroid/view/View;F)V
...
.method public final OoooO0(Llyiahf/vczjk/xz9;)V
    .locals 4

    iget-object v0, p1, Llyiahf/vczjk/xz9;->OooO0O0:Landroid/view/View;
    ...
    new-instance v1, Llyiahf/vczjk/ps0;

    invoke-direct {v1, v0}, Llyiahf/vczjk/ps0;-><init>(Landroid/view/View;)V
    ...
    sget-object v3, Llyiahf/vczjk/dja;->OooO00o:Llyiahf/vczjk/jja;

    invoke-virtual {v3, v2, v1}, Llyiahf/vczjk/jja;->Oooo00O(Landroid/view/View;Landroid/graphics/Matrix;)V
