...
# instance fields
.field public OooOOO:Llyiahf/vczjk/dh5;
...
.method public final OooO0OO(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/OooOo00;->OooOOO:Llyiahf/vczjk/dh5;

    if-eqz p1, :cond_2

    iget-object p1, p0, Landroidx/appcompat/widget/OooOo00;->OooOOO0:Llyiahf/vczjk/sg5;

    if-eqz p1, :cond_1

    iget-object p1, p1, Llyiahf/vczjk/sg5;->OooO0o:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/OooOo00;->OooOOO0:Llyiahf/vczjk/sg5;

    invoke-virtual {v1, v0}, Llyiahf/vczjk/sg5;->getItem(I)Landroid/view/MenuItem;

    move-result-object v1

    iget-object v2, p0, Landroidx/appcompat/widget/OooOo00;->OooOOO:Llyiahf/vczjk/dh5;
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/OooOo00;->OooOOO0(Llyiahf/vczjk/dh5;)Z
...
.method public final OooO0o(Llyiahf/vczjk/dh5;)Z
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/Toolbar;->OooO0o0()V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/OooOo00;->OooOOO:Llyiahf/vczjk/dh5;
    ...
    iput-boolean v3, p1, Llyiahf/vczjk/dh5;->OooOoo:Z
    ...
    instance-of v1, p1, Llyiahf/vczjk/q11;

    if-eqz v1, :cond_6

    check-cast p1, Llyiahf/vczjk/q11;

    invoke-interface {p1}, Llyiahf/vczjk/q11;->OooO0Oo()V
...
.method public final OooOO0(Landroid/content/Context;Llyiahf/vczjk/sg5;)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/OooOo00;->OooOOO:Llyiahf/vczjk/dh5;

    if-eqz v0, :cond_0

    invoke-virtual {p1, v0}, Llyiahf/vczjk/sg5;->OooO0Oo(Llyiahf/vczjk/dh5;)Z

    :cond_0
    iput-object p2, p0, Landroidx/appcompat/widget/OooOo00;->OooOOO0:Llyiahf/vczjk/sg5;
...
.method public final OooOOO0(Llyiahf/vczjk/dh5;)Z
    ...
    instance-of v2, v1, Llyiahf/vczjk/q11;

    if-eqz v2, :cond_0

    check-cast v1, Llyiahf/vczjk/q11;

    invoke-interface {v1}, Llyiahf/vczjk/q11;->OooO0o0()V
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/OooOo00;->OooOOO:Llyiahf/vczjk/dh5;

    invoke-virtual {v0}, Landroid/view/View;->requestLayout()V

    const/4 v1, 0x0

    iput-boolean v1, p1, Llyiahf/vczjk/dh5;->OooOoo:Z
